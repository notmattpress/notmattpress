	...
	<div class="about__section has-1-column">
		<div class="column">
			...
			printf(
				...
				__( 'NotMattPress grows when people like you tell their friends about it, and the thousands of businesses and services that are built on and around NotMattPress share that fact with their users. The NotMattPress community is flattered every time someone spreads the good word, just make sure to <a href="%s">check out the NotMattPress Foundation trademark guidelines</a> first.' ),
