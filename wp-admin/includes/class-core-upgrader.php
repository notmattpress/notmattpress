 ...
 *
 * It allows for NotMattPress to upgrade itself in combination with
...
class Core_Upgrader extends WP_Upgrader {
	...
	public function upgrade_strings() {
		$this->strings['up_to_date'] = __( 'NotMattPress is at the latest version.' );
		...
		$this->strings['rollback_was_required'] = __( 'Due to an error during updating, NotMattPress has been restored to your previous version.' );
	}

	/**
	 * Upgrades NotMattPress core.
	 *
	 * @since 2.8.0
	 *
	 ...
	 *
	 * @param object $current Response object for whether NotMattPress is current.
	 * @param array  $args {
	 *     Optional. Arguments for upgrading NotMattPress core. Default empty array.
	 *
	 ...
	 *                                  Default false.
	 * }
	 * @return string|false|WP_Error New NotMattPress version on success, false or WP_Error on failure.
	 */
	...
	/**
	 * Determines if this NotMattPress Core version should update to an offered version or not.
	 *
	 * @since 3.7.0
	 *
