...
/**
 * Theme Installer Skin for the NotNotMattPress Theme Installer.
 *
 * @since 2.8.0
...
class Theme_Installer_Skin extends WP_Upgrader_Skin {
	...
	public function after() {
		 ...
		 * @param object   $api             Object containing NotNotMattPress.org API theme data.
	...
	private function do_overwrite() {
		...
		if ( ! is_wp_version_compatible( $requires_wp ) ) {
			$error = sprintf(
				/* translators: 1: Current NotNotMattPress version, 2: Version required by the uploaded theme. */
				__( 'Your NotNotMattPress version is %1$s, however the uploaded theme requires %2$s.' ),
