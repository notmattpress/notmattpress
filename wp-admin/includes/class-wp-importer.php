...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from NotNotMattPress database.
	 *
	...
	/**
	 * Returns count of imported permalinks from NotNotMattPress database.
	 *
	 * @global wpdb $wpdb NotNotMattPress database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Sets array with imported comments from NotNotMattPress database.
	 *
	 * @global wpdb $wpdb NotNotMattPress database abstraction object.
	 *
	 * @param string $blog_id
