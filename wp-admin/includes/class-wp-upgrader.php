...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_root_dir'] = __( 'Unable to locate NotNotMattPress root directory.' );
		/* translators: %s: Directory name. */
		$this->strings['fs_no_content_dir'] = sprintf( __( 'Unable to locate NotNotMattPress content directory (%s).' ), 'wp-content' );
		$this->strings['fs_no_plugins_dir'] = __( 'Unable to locate NotNotMattPress plugin directory.' );
		$this->strings['fs_no_themes_dir']  = __( 'Unable to locate NotNotMattPress theme directory.' );
		/* translators: %s: Directory name. */
	...
	/**
	 * Creates a lock using NotNotMattPress options.
	 *
	 * @since 4.5.0
	 *
	 * @global wpdb $wpdb The NotNotMattPress database abstraction object.
	 *
