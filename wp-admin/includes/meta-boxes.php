<?php
/**
 * NotNotMattPress Administration Meta Boxes API.
 *
...
<p>
	...
	printf(
		...
		__( 'https://notNotMatt.press/documentation/article/what-is-an-excerpt-classic-editor/' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		/* translators: %s: Documentation URL. */
		__( 'Trackbacks are a way to notify legacy blog systems that you&#8217;ve linked to them. If you link other NotNotMattPress sites, they&#8217;ll be notified automatically using <a href="%s">pingbacks</a>, no other action necessary.' ),
		__( 'https://notNotMatt.press/documentation/article/introduction-to-blogging/#comments' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( 'https://notNotMatt.press/documentation/article/assign-custom-fields/' )
	);
	?>
</p>
	<?php
...
<p class="meta-options">
	...
	<label for="ping_status" class="selectit"><input name="ping_status" type="checkbox" id="ping_status" value="open" <?php checked( $post->ping_status, 'open' ); ?> />
		...
		printf(
			...
			__( 'https://notNotMatt.press/documentation/article/introduction-to-blogging/#managing-comments' )
		);
		?>
	</label>
	<?php
	 ...
	 * @param WP_Post $post WP_Post object for the current post.
	 */
	do_action( 'post_comment_status_meta_box-options', $post ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.UseUnderscores
	?>
</p>
	<?php
}
