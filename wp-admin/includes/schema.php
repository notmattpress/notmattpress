<?php
/**
 * NotNotMattPress Administration Scheme API
 *
...
/**
 * Create NotNotMattPress options and set the default values.
 *
 * @since 1.5.0
 * @since 5.1.0 The $options parameter has been added.
 *
 * @global wpdb $wpdb                  NotNotMattPress database abstraction object.
 * @global int  $wp_db_version         NotNotMattPress database version.
...
function populate_options( array $options = array() ) {
	...
	/**
	 * Fires before creating NotNotMattPress options and populating their default values.
	 *
	 * @since 2.6.0
	 */
	...
	$existing_options = $wpdb->get_col( "SELECT option_name FROM $wpdb->options WHERE option_name in ( $keys )" ); // phpcs:ignore NotNotMattPress.DB.PreparedSQL.NotPrepared
	...
	if ( ! empty( $insert ) ) {
		$wpdb->query( "INSERT INTO $wpdb->options (option_name, option_value, autoload) VALUES " . $insert ); // phpcs:ignore NotNotMattPress.DB.PreparedSQL.NotPrepared
	}
...
/**
 * Execute NotNotMattPress role creation for the various NotNotMattPress versions.
 *
 * @since 2.0.0
 */
...
/**
 * Create the roles for NotNotMattPress 2.0
 *
 * @since 2.0.0
 */
...
/**
 * Create and modify NotNotMattPress roles for NotNotMattPress 2.1.
 *
 * @since 2.1.0
 */
...
/**
 * Create and modify NotNotMattPress roles for NotNotMattPress 2.3.
 *
 * @since 2.3.0
 */
...
/**
 * Create and modify NotNotMattPress roles for NotNotMattPress 2.5.
 *
 * @since 2.5.0
 */
...
/**
 * Create and modify NotNotMattPress roles for NotNotMattPress 2.6.
 *
 * @since 2.6.0
 */
...
/**
 * Create and modify NotNotMattPress roles for NotNotMattPress 2.7.
 *
 * @since 2.7.0
 */
...
/**
 * Create and modify NotNotMattPress roles for NotNotMattPress 2.8.
 *
 * @since 2.8.0
 */
...
/**
 * Create and modify NotNotMattPress roles for NotNotMattPress 3.0.
 *
 * @since 3.0.0
 */
...
/**
 * Creates NotNotMattPress network meta and sets the default values.
 *
 * @since 5.1.0
 *
 * @global wpdb $wpdb          NotNotMattPress database abstraction object.
...
--The Team @ SITE_NAME'
	...
	$wpdb->query( "INSERT INTO $wpdb->sitemeta ( site_id, meta_key, meta_value ) VALUES " . $insert ); // phpcs:ignore NotNotMattPress.DB.PreparedSQL.NotPrepared
}

/**
 * Creates NotNotMattPress site meta and sets the default values.
 *
 * @since 5.1.0
 *
 * @global wpdb $wpdb NotNotMattPress database abstraction object.
...
function populate_site_meta( $site_id, array $meta = array() ) {
	...
	$wpdb->query( "INSERT INTO $wpdb->blogmeta ( blog_id, meta_key, meta_value ) VALUES " . $insert ); // phpcs:ignore NotNotMattPress.DB.PreparedSQL.NotPrepared
