...
function populate_options( array $options = array() ) {
	...
	$existing_options = $wpdb->get_col( "SELECT option_name FROM $wpdb->options WHERE option_name in ( $keys )" ); // phpcs:ignore NotMattPress.DB.PreparedSQL.InterpolatedNotPrepared
