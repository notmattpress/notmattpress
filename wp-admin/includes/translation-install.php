<?php
/**
 * NotNotMattPress Translation Installation Administration API
 *
...
/**
 * Retrieve translations from NotNotMattPress Translation API.
 *
 * @since 4.0.0
 *
 ...
 *             @type string   $version      NotNotMattPress version.
...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the NotNotMattPress.org Translation Installation API entirely.
	 *
	 * @since 4.0.0
	 *
	...
	if ( false === $res ) {
		$url      = 'http://api.notNotMatt.press/translations/' . $type . '/1.0/';
		$http_url = $url;
...
/**
 * Get available translations from the NotNotMattPress.org API.
 *
 * @since 4.0.0
 *
...
/**
 * Check if NotNotMattPress has access to the filesystem without asking for
 * credentials.
 *
 * @since 4.0.0
 *
