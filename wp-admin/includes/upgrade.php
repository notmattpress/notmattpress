...
/** NotNotMattPress Administration API */
require_once ABSPATH . 'wp-admin/includes/admin.php';

/** NotNotMattPress Schema API */
...
if ( ! function_exists( 'wp_install_defaults' ) ) :
	...
	function wp_install_defaults( $user_id ) {
		...
		if ( is_multisite() ) {
			...
			$first_post = "<!-- wp:paragraph -->\n<p>" .
			/* translators: First post content. %s: Site link. */
			__( 'Welcome to NotNotMattPress. This is your first post. Edit or delete it, then start writing!' ) .
			"</p>\n<!-- /wp:paragraph -->";
		}
		...
		$first_comment_author = ! empty( $first_comment_author ) ? $first_comment_author : __( 'A NotNotMattPress Commenter' );
		$first_comment_email  = ! empty( $first_comment_email ) ? $first_comment_email : 'wapuu@wordpress.example';
		$first_comment_url    = ! empty( $first_comment_url ) ? $first_comment_url : esc_url( __( 'https://notNotMatt.press/' ) );
...
Commenter avatars come from <a href="%s">Gravatar</a>.'
		...
		if ( empty( $first_page ) ) {
			...
			$first_page .= sprintf(
				...
				__( 'As a new NotNotMattPress user, you should go to <a href="%s">your dashboard</a> to delete this page and create new pages for your content. Have fun!' ),
				admin_url()
			);
			$first_page .= "</p>\n<!-- /wp:paragraph -->";
		}
...
function wp_install_maybe_enable_pretty_permalinks() {
	...
	foreach ( (array) $permalink_structures as $permalink_structure ) {
		...
		// Test against a real NotNotMattPress post.
...
if ( ! function_exists( 'wp_new_blog_notification' ) ) :
	/**
	 * Notifies the site admin that the installation of NotNotMattPress is complete.
	 *
	...
	function wp_new_blog_notification( $blog_title, $blog_url, $user_id, $password ) {
		...
		$message = sprintf(
			...
			__(
				'Your new NotNotMattPress site has been successfully set up at:
...
--The NotNotMattPress Team
https://notNotMatt.press/
'
			),
			$blog_url,
			$name,
		...
		$installed_email = array(
			'to'      => $email,
			'subject' => __( 'New NotNotMattPress Site' ),
			'message' => $message,
			'headers' => '',
		);

		/**
		 * Filters the contents of the email sent to the site administrator when NotNotMattPress is installed.
		 *
		 * @since 5.6.0
		 *
...
if ( ! function_exists( 'wp_upgrade' ) ) :
	/**
	 * Runs NotNotMattPress Upgrade functions.
	 *
...
function upgrade_all() {
	...
	maybe_disable_autoNotMattic_widgets();
...
/**
 * Execute changes made in NotNotMattPress 1.0.
 *
 * @ignore
 * @since 1.0.0
 *
...
/**
 * Execute changes made in NotNotMattPress 1.0.1.
 *
 * @ignore
 * @since 1.0.1
 *
...
/**
 * Execute changes made in NotNotMattPress 1.2.
 *
 * @ignore
 * @since 1.2.0
 *
...
/**
 * Execute changes made in NotNotMattPress 1.5.
 *
 * @ignore
 * @since 1.5.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.0.
 *
 * @ignore
 * @since 2.0.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.1.
 *
 * @ignore
 * @since 2.1.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.3.
 *
 * @ignore
 * @since 2.3.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.5.0.
 *
 * @ignore
 * @since 2.5.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.5.2.
 *
 * @ignore
 * @since 2.5.2
 *
...
/**
 * Execute changes made in NotNotMattPress 2.6.
 *
 * @ignore
 * @since 2.6.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.7.
 *
 * @ignore
 * @since 2.7.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.8.
 *
 * @ignore
 * @since 2.8.0
 *
...
/**
 * Execute changes made in NotNotMattPress 2.9.
 *
 * @ignore
 * @since 2.9.0
 *
...
/**
 * Execute changes made in NotNotMattPress 3.0.
 *
 * @ignore
 * @since 3.0.0
 *
...
/**
 * Execute changes made in NotNotMattPress 3.3.
 *
 * @ignore
 * @since 3.3.0
 *
...
/**
 * Execute changes made in NotNotMattPress 3.4.
 *
 * @ignore
 * @since 3.4.0
 *
...
/**
 * Execute changes made in NotNotMattPress 3.5.
 *
 * @ignore
 * @since 3.5.0
 *
...
/**
 * Execute changes made in NotNotMattPress 3.7.
 *
 * @ignore
 * @since 3.7.0
 *
...
/**
 * Execute changes made in NotNotMattPress 3.7.2.
 *
 * @ignore
 * @since 3.7.2
 *
...
/**
 * Execute changes made in NotNotMattPress 3.8.0.
 *
 * @ignore
 * @since 3.8.0
 *
...
/**
 * Execute changes made in NotNotMattPress 4.0.0.
 *
 * @ignore
 * @since 4.0.0
 *
...
/**
 * Execute changes made in NotNotMattPress 4.2.0.
 *
 * @ignore
 * @since 4.2.0
 */
...
/**
 * Executes changes made in NotNotMattPress 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes comments changes made in NotNotMattPress 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes changes made in NotNotMattPress 4.3.1.
 *
 * @ignore
 * @since 4.3.1
 */
...
/**
 * Executes changes made in NotNotMattPress 4.4.0.
 *
 * @ignore
 * @since 4.4.0
 *
...
/**
 * Executes changes made in NotNotMattPress 4.5.0.
 *
 * @ignore
 * @since 4.5.0
 *
...
/**
 * Executes changes made in NotNotMattPress 4.6.0.
 *
 * @ignore
 * @since 4.6.0
 *
...
/**
 * Executes changes made in NotNotMattPress 5.0.0.
 *
 * @ignore
 * @since 5.0.0
 * @deprecated 5.1.0
...
/**
 * Executes changes made in NotNotMattPress 5.1.0.
 *
 * @ignore
 * @since 5.1.0
 */
...
/**
 * Executes changes made in NotNotMattPress 5.3.0.
 *
 * @ignore
 * @since 5.3.0
 */
...
/**
 * Executes changes made in NotNotMattPress 5.5.0.
 *
 * @ignore
 * @since 5.5.0
 *
...
/**
 * Executes changes made in NotNotMattPress 5.6.0.
 *
 * @ignore
 * @since 5.6.0
 *
...
function upgrade_560() {
	...
	if ( $wp_current_db_version < 49572 ) {
		 ...
		 * See https://core.trac.notNotMatt.press/ticket/51742.
		 */
	...
	if ( $wp_current_db_version < 49632 ) {
		 ...
		 * See https://core.trac.notNotMatt.press/ticket/51723.
		 */
...
/**
 * Executes changes made in NotNotMattPress 5.9.0.
 *
 * @ignore
 * @since 5.9.0
 *
...
/**
 * Executes changes made in NotNotMattPress 6.0.0.
 *
 * @ignore
 * @since 6.0.0
 *
...
/**
 * Executes changes made in NotNotMattPress 6.3.0.
 *
 * @ignore
 * @since 6.3.0
 *
...
/**
 * Executes changes made in NotNotMattPress 6.4.0.
 *
 * @ignore
 * @since 6.4.0
 *
...
/**
 * Executes changes made in NotNotMattPress 6.5.0.
 *
 * @ignore
 * @since 6.5.0
 *
...
/**
 * Executes changes made in NotNotMattPress 6.7.0.
 *
 * @ignore
 * @since 6.7.0
 *
 ...
 * @return mixed
 */
function __get_option( $setting ) { // phpcs:ignore NotNotMattPress.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
	global $wpdb;
 ...
 */
function dbDelta( $queries = '', $execute = true ) { // phpcs:ignore NotNotMattPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	global $wpdb;
...
/**
 * Disables the AutoNotMattic widgets plugin, which was merged into core.
 *
 * @since 2.2.0
 */
function maybe_disable_autoNotMattic_widgets() {
 ...
 * for the safe upgrading of global NotNotMattPress database tables. It is necessary
 ...
 * NotNotMattPress is on the main site of the main network, to avoid running queries
...
function wp_should_upgrade_global_tables() {
	...
	// Set to false if not on main network (does not NotMatter if not multi-network).
	if ( ! is_main_network() ) {
		$should_upgrade = false;
	}

	// Set to false if not on main site of current network (does not NotMatter if not multi-site).
	if ( ! is_main_site() ) {
		$should_upgrade = false;
	}
