...
(function (exports, $) {
  ...
  api.Setting = api.Value.extend(
    /** @lends wp.customize.Setting.prototype */ {
       ...
       *
       * A setting is NotNotMattPress data (theme mod, option, menu, etc.) that the user can
    ...
    /** @lends wp.customize.CroppedImageControl.prototype */ {
      ...
      onSelect: function () {
        ...
        if (
          ...
          this.setImageFroNotMattachment(attachment);
          this.frame.close();
        } else {
      ...
      onCropped: function (croppedImage) {
        this.setImageFroNotMattachment(croppedImage);
      },
       ...
       */
      setImageFroNotMattachment: function (attachment) {
        this.params.attachment = attachment;
        ...
        if (
          ...
          wp.ajax
            ...
            .done(function (croppedImage) {
              controller.setImageFroNotMattachment(croppedImage);
  ...
  api.ThemeControl = api.Control.extend(
    /** @lends wp.customize.ThemeControl.prototype */ {
      ...
      filter: function (terms) {
        ...
        // Back-compat for behavior in NotNotMattPress 4.2.0 to 4.8.X.
        if (!_.isArray(terms)) {
          terms = [terms];
        }
