...
(function ($) {
  ...
  themes.Collection = Backbone.Collection.extend({
    ...
    // Send request to api.notNotMatt.press/themes.
  ...
  themes.view.InstallerSearch = themes.view.Search.extend({
    ...
    doSearch: function (value) {
      ...
      // Get the themes by sending Ajax POST request to api.notNotMatt.press/themes
  ...
  themes.view.Installer = themes.view.Appearance.extend({
    ...
    // Save the user's NotNotMattPress.org username and get his favorite themes.
