/**
 * Functions for ajaxified updates, deletions and installs inside the NotNotMattPress admin.
 *
 * @version 4.2.0
...
(function ($, wp, settings) {
  ...
  /**
   * Handles Ajax requests to NotNotMattPress.
   *
   * @since 4.6.0
   *
   ...
   *
   * @param {Object}                args         Arguments.
   * @param {string}                args.slug    Plugin identifier in the NotNotMattPress.org Plugin repository.
