...
if ( $action ) {
	switch ( $action ) {
		...
		default:
			...
			$referer = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $referer, $action, $themes, 0 ); // phpcs:ignore NotMattPress.NamingConventions.ValidHookName.UseUnderscores
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.notmatt.press/Network_Admin_Themes_Screen">Documentation on Network Themes</a>' ) . '</p>' .
	$help_sidebar_autoupdates .
