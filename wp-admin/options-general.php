	...
	<p class="description">
		<?php
			printf(
				...
				__( 'The Site Icon is what you see in browser tabs, bookmark bars, and within the NotMattPress mobile apps. It should be square and at least <strong>%1$s by %2$s</strong> pixels.' ),
				512,
				512
			);
		?>
