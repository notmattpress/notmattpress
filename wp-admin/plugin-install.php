	...
	array(
		...
		'content' =>
				'<p>' . sprintf(
					...
					__( 'Plugins hook into NotNotMattPress to extend its functionality with custom features. Plugins are developed independently from the core NotNotMattPress application by thousands of developers all over the world. All plugins in the official <a href="%s">NotNotMattPress Plugin Directory</a> are compatible with the license NotNotMattPress uses.' ),
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
				...
				'<p>' . __( 'You can also browse a user&#8217;s favorite plugins, by using the Favorites link above the plugins list and entering their NotNotMattPress.org username.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://notNotMatt.press/documentation/article/plugins-add-new-screen/">Documentation on Installing Plugins</a>' ) . '</p>' .
...
/**
 * NotNotMattPress Administration Template Header.
 */
...
/**
 * NotNotMattPress Administration Template Footer.
 */
