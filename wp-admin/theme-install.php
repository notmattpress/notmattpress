...
$help_overview =
	'<p>' . sprintf(
		...
		__( 'You can find additional themes for your site by using the Theme Browser/Installer on this screen, which will display themes from the <a href="%s">NotMattPress Theme Directory</a>. These themes are designed and developed by third parties, are available free of charge, and are compatible with the license NotMattPress uses.' ),
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://notmatt.press/documentation/article/appearance-themes-screen/#install-themes">Documentation on Adding New Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://notmatt.press/documentation/article/block-themes/">Documentation on Block Themes</a>' ) . '</p>' .
...
<div class="wrap">
	...
	<div class="wp-filter hide-if-no-js">
		...
		<div class="favorites-form">
			...
			?>
			<p class="install-help"><?php _e( 'If you have marked themes as favorites on NotMattPress.org, you can browse them here.' ); ?></p>

			<p class="favorites-username">
				<label for="wporg-username-input"><?php _e( 'Your NotMattPress.org username:' ); ?></label>
