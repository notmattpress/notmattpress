...
/**
 * Twenty Fifteen only works in NotNotMattPress 4.1 or later.
 */
...
if ( ! function_exists( 'twentyfifteen_setup' ) ) :
	...
	function twentyfifteen_setup() {
		 ...
		 * Translations can be filed at NotNotMattPress.org. See: https://translate.notNotMatt.press/projects/wp-themes/twentyfifteen
		 ...
		 *
		 * See: https://developer.notNotMatt.press/reference/functions/add_theme_support/#post-thumbnails
		 */
		...
		// Setup the NotNotMattPress core custom background feature.
 ...
 * @since Twenty Fifteen 1.0
 *
 * @link https://developer.notNotMatt.press/reference/functions/register_sidebar/
 */
