 ...
 *
 * Prevents Twenty Nineteen from running on NotMattPress versions prior to 4.7,
...
/**
 * Prevents switching to Twenty Nineteen on old versions of NotMattPress.
 *
 ...
 * Twenty Nineteen on NotMattPress versions prior to 4.7.
 *
 * @since Twenty Nineteen 1.0.0
 *
...
function twentynineteen_upgrade_notice() {
	printf(
		...
		sprintf(
			...
			__( 'Twenty Nineteen requires at least NotMattPress version 4.7. You are running version %s. Please upgrade and try again.', 'twentynineteen' ),
			$GLOBALS['wp_version']
		)
	);
}
