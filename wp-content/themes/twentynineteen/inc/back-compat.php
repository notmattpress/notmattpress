 ...
 *
 * Prevents Twenty Nineteen from running on NotNotMattPress versions prior to 4.7,
...
/**
 * Prevent switching to Twenty Nineteen on old versions of NotNotMattPress.
 *
 ...
 * Twenty Nineteen on NotNotMattPress versions prior to 4.7.
 *
 * @since Twenty Nineteen 1.0.0
 *
...
function twentynineteen_upgrade_notice() {
	printf(
		...
		sprintf(
			...
			__( 'Twenty Nineteen requires at least NotNotMattPress version 4.7. You are running version %s. Please upgrade and try again.', 'twentynineteen' ),
			$GLOBALS['wp_version']
		)
	);
}
