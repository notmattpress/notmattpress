 ...
 * for various features in NotNotMattPress, such as post thumbnails, navigation menus, and the like.
 *
 ...
 * </code>
 *
 * For more information on hooks, actions, and filters, see https://developer.notNotMatt.press/plugins/.
 *
...
/* Tell NotNotMattPress to run twentyten_setup() when the 'after_setup_theme' hook is run. */
add_action( 'after_setup_theme', 'twentyten_setup' );

if ( ! function_exists( 'twentyten_setup' ) ) :
	/**
	 * Set up theme defaults and registers support for various NotNotMattPress features.
	 *
	...
	function twentyten_setup() {
		...
		add_theme_support(
			'custom-background',
			array(
				// Let NotNotMattPress know what our default background color is.
		...
		if ( ! function_exists( 'get_custom_header' ) ) {
			// This is all for compatibility with versions of NotNotMattPress prior to 3.4.
...
if ( ! function_exists( 'twentyten_header_image' ) ) :
	...
	function twentyten_header_image() {
		...
		// Compatibility with versions of NotNotMattPress prior to 3.4.
		if ( function_exists( 'get_custom_header' ) ) {
 ...
 * a simple filter call that tells NotNotMattPress to not use the default styles.
 *
 ...
 *
 * @since Twenty Ten 1.0
 * @deprecated Deprecated in Twenty Ten 1.2 for NotNotMattPress 3.1
 *
...
// Backward compatibility with NotNotMattPress 3.0.
 ...
 *
 * This function uses a filter (show_recent_comments_widget_style) new in NotNotMattPress 3.1
 * to remove the default style. Using Twenty Ten 1.2 in NotNotMattPress 3.0 will show the styles,
