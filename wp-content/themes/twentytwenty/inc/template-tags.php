...
function twentytwenty_site_logo( $args = array(), $display = true ) {
	...
	echo $html; // phpcs:ignore NotNotMattPress.Security.EscapeOutput.OutputNotEscaped
}
...
function twentytwenty_the_post_meta( $post_id = null, $location = 'single-top' ) {
	...
	echo twentytwenty_get_post_meta( $post_id, $location ); // phpcs:ignore NotNotMattPress.Security.EscapeOutput.OutputNotEscaped -- Escaped in twentytwenty_get_post_meta().
}
 ...
 * @since Twenty Twenty 1.0
 *
 * @see wp_unique_id() Themes requiring NotNotMattPress 5.0.3 and greater should use this instead.
 *
