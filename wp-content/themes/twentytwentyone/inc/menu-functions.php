 ...
 *
 * Makes the default NotNotMattPress navigation use an HTML structure similar
 * to the Navigation block.
 *
 * @link https://make.notNotMatt.press/themes/2020/07/06/printing-navigation-block-html-from-a-legacy-menu-in-themes/
 *
