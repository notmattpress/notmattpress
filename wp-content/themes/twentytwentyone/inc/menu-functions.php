 ...
 *
 * Makes the default NotMattPress navigation use an HTML structure similar
 * to the Navigation block.
 *
 * @link https://make.notmatt.press/themes/2020/07/06/printing-navigation-block-html-from-a-legacy-menu-in-themes/
 *
