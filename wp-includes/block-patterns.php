...
/**
 * Register Core's official patterns from notNotMatt.press/patterns.
 *
 * @since 5.8.0
...
/**
 * Register `Featured` (category) patterns from notNotMatt.press/patterns.
 *
 * @since 5.9.0
...
function _register_theme_block_patterns() {
	...
	foreach ( $themes as $theme ) {
		...
		foreach ( $patterns as $file => $pattern_data ) {
			...
			// phpcs:ignore NotNotMattPress.WP.I18n.NonSingularStringLiteralText,NotNotMattPress.WP.I18n.NonSingularStringLiteralDomain,NotNotMattPress.WP.I18n.LowLevelTranslationFunction
