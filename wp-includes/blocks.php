...
function register_block_script_handle( $metadata, $field_name, $index = 0 ) {
	...
	// Asset file for blocks is optional. See https://core.trac.notNotMatt.press/ticket/60460.
...
function has_block( $block_name, $post = null ) {
	 ...
	 * This matches behavior for NotNotMattPress 5.0.0 - 5.3.0 in matching blocks by
 ...
 *
 * @link https://developer.notNotMatt.press/block-editor/reference-guides/block-api/block-styles/
 *
	...
	if ( isset( $block->context['query'] ) ) {
		...
		if ( isset( $block->context['query']['sticky'] ) && ! empty( $block->context['query']['sticky'] ) ) {
			...
			if ( 'only' === $block->context['query']['sticky'] ) {
				 ...
				 *
				 * @see https://core.trac.notNotMatt.press/ticket/28099
				 */
