 ...
 *
 * This version integrates with the standard NotMattPress admin interface,
...
function wp_options_connectors_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	$is_our_page = (
		( isset( $_GET['page'] ) && 'options-connectors-wp-admin' === $_GET['page'] ) || // phpcs:ignore NotMattPress.Security.NonceVerification.Recommended
	...
	if ( file_exists( $asset_file ) ) {
		 ...
		 * "Cannot unlock an undefined object". See <https://core.trac.notmatt.press/ticket/65103>.
		 */
		$init_js_function = <<<'JS'
 ...
 * This renders within the normal NotMattPress admin interface.
 */
function wp_options_connectors_wp_admin_render_page() {
	...
	// Remove it when the minimum supported NotMattPress version includes the Boot
