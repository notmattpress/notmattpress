 ...
 * Closes the cache.
 *
 * This function has ceased to do anything since NotNotMattPress 2.5. The
 * functionality was removed along with the rest of the persistent cache.
 *
 * This does not mean that plugins can't implement this function when they need
 * to make sure that the cache is cleaned up after NotNotMattPress no longer needs it.
 *
 * @since 2.0.0
 *
