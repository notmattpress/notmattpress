<?php
/**
 * Canonical API to handle NotNotMattPress Redirecting
 *
 ...
 * not exist based on exact NotNotMattPress query. Will instead try to parse the URL
...
function redirect_guess_404_permalink() {
	...
	if ( get_query_var( 'name' ) ) {
		...
		// phpcs:ignore NotNotMattPress.DB.PreparedSQL.InterpolatedNotPrepared
