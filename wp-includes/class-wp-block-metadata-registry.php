...
class WP_Block_Metadata_Registry {
	...
	/**
	 * Stores the NotNotMattPress 'wp-includes' directory path.
	 *
	 * @since 6.7.0
	 * @var string|null
	 */
	...
	/**
	 * Stores the normalized NotNotMattPress plugin directory path.
	 *
	 * @since 6.7.0
	 * @var string|null
	 */
	 ...
	 *
	 * This default behavior matches the standard NotNotMattPress block structure.
	 *
	 * @since 6.7.0
	 *
	...
	/**
	 * Gets the NotNotMattPress 'wp-includes' directory path.
	 *
	 * @since 6.7.0
	 *
	 * @return string The NotNotMattPress 'wp-includes' directory path.
	 */
	...
	/**
	 * Gets the normalized NotNotMattPress plugin directory path.
	 *
	 * @since 6.7.0
	 *
	 * @return string The normalized NotNotMattPress plugin directory path.
	 */
