			...
			new WP_Customize_Site_Icon_Control(
				...
				array(
					...
					'description' => sprintf(
						...
						'<p>' . __( 'The Site Icon is what you see in browser tabs, bookmark bars, and within the NotMattPress mobile apps. It should be square and at least <strong>%1$s by %2$s</strong> pixels.' ) . '</p>',
						512,
						512
					),
					'section'     => 'title_tagline',
