<?php
/**
 * NotNotMattPress Customize Widgets classes
 *
...
final class WP_Customize_Widgets {
	 ...
	 *
	 * When in preview, hook to {@see 'customize_register'} for settings after NotNotMattPress is loaded
	...
	public function print_styles() {
		...
		do_action( 'admin_print_styles-widgets.php' ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.UseUnderscores
	...
	public function print_scripts() {
		/** This action is documented in wp-admin/admin-header.php */
		do_action( 'admin_print_scripts-widgets.php' ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.UseUnderscores
	...
	public function print_footer_scripts() {
		...
		do_action( 'admin_print_footer_scripts-widgets.php' ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.UseUnderscores

		/** This action is documented in wp-admin/admin-footer.php */
		do_action( 'admin_print_footer_scripts' );

		/** This action is documented in wp-admin/admin-footer.php */
		do_action( 'admin_footer-widgets.php' ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.UseUnderscores
	}
