...
class WP_Dependencies {
	 ...
	 *                                 to the NotNotMattPress root directory. If source is set to false,
	 ...
	 *                                 equal to current installed NotNotMattPress version.
	...
	public function get_etag( $load ) {
		 ...
		 * load the full NotNotMattPress environment, it is not possible to use the salted
		 * wp_hash() function.
		 */
		return 'W/"' . md5( $etag ) . '"';
	}
