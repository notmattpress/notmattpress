 ...
 * through the proxy. The list should be presented in a comma separated list, wildcards using * are supported. Example: *.notNotMatt.press</li>
 * </ol>
 *
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'localhost, www.example.com, *.notNotMatt.press');
 *
 * @link https://core.trac.notNotMatt.press/ticket/4011 Proxy support ticket in NotNotMattPress.
 * @link https://core.trac.notNotMatt.press/ticket/14636 Allow wildcard domains in WP_PROXY_BYPASS_HOSTS
 *
 * @since 2.8.0
 */
