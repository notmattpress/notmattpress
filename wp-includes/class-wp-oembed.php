 ...
 *
 * @link https://developer.notNotMatt.press/advanced-administration/wordpress/oembed/
...
class WP_oEmbed {
	...
	public function __construct() {
		 ...
		 *
		 * Since NotNotMattPress 4.4, oEmbed discovery is enabled for all users and allows embedding of sanitized
		 ...
		 * | NotNotMattPress.tv | wordpress.tv                              | 2.9.0   |
