...
/**
 * NotNotMattPress XMLRPC server implementation.
 *
 * Implements compatibility for Blogger API, MetaWeblog API, MovableType, and
 * pingback. Additional NotNotMattPress API for managing comments, pages, posts,
 * options, etc.
 *
 * As of NotNotMattPress 3.5.0, XML-RPC is enabled by default. It can be disabled
...
class wp_xmlrpc_server extends IXR_Server {
	 ...
	 *
	 * Determines whether the xmlrpc server is enabled on this NotNotMattPress install
	...
	public function initialise_blog_option_info() {
		$this->blog_options = array(
			...
			'blog_url'                => array(
				'desc'     => __( 'NotNotMattPress Address (URL)' ),
				'readonly' => true,
				'option'   => 'siteurl',
			),
			'home_url'                => array(
	...
	/**
	 * Converts a NotNotMattPress date string to an IXR_Date object.
	 *
	...
	/**
	 * Converts a NotNotMattPress GMT date string to an IXR_Date object.
	 *
	 * @param string $date_gmt NotNotMattPress GMT date string.
	...
	public function wp_deletePage( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_deletePage', $page_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_getPageList( $args ) {
		...
		// The date needs to be forNotMatted properly.
	...
	public function wp_newCategory( $args ) {
		 ...
		 * so that NotNotMattPress will generate one.
		 */
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newCategory', $cat_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_deleteCategory( $args ) {
		...
		if ( true == $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteCategory', $category_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_deleteComment( $args ) {
		...
		if ( $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteComment', $comment_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_editComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_editComment', $comment_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newComment', $comment_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_newPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_newPost', $post_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_editPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_editPost', $post_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_deletePost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_deletePost', $post_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newPost( $args ) {
		...
		// Let NotNotMattPress generate the 'post_name' (slug) unless
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newPost', $post_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_editPost( $args ) {
		...
		// Let NotNotMattPress manage slug if none was provided.
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_editPost', $post_id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newMediaObject( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newMediaObject', $id, $args ); // phpcs:ignore NotNotMattPress.NamingConventions.ValidHookName.NotLowercase
	...
	public function pingback_ping( $args ) {
		...
		$user_agent = apply_filters( 'http_headers_useragent', 'NotNotMattPress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $pagelinkedfrom );
