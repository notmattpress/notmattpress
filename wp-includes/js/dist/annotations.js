/******/ (() => {
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/@wordpress/annotations/build-module/store/constants.js
  /**
  ...
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: ./node_modules/@wordpress/annotations/build-module/block/index.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  const addAnnotationClassName = (OriginalComponent) => {
    return (0, external_wp_data_namespaceObject.withSelect)(
      (select, { clientId, className }) => {
        const annotations =
    ...
    switch (action.type) {
      case "ANNOTATION_ADD":
        ...
        const previousAnnotationsForBlock =
          (_state$blockClientId = state?.[blockClientId]) !== null &&
  ...
  /* harmony default export */ const reducer = annotations; // CONCATENATED MODULE: ./node_modules/@wordpress/annotations/build-module/store/selectors.js
   ...
   */
  const __experimentalGetAnnotationsForBlock = (0,
  external_wp_data_namespaceObject.createSelector)(
    ...
    (state, blockClientId) => {
      ...
      return [
        (_state$blockClientId2 = state?.[blockClientId]) !== null &&
  ...
  function __experimentalGetAllAnnotationsForBlock(state, blockClientId) {
    ...
    return (_state$blockClientId3 = state?.[blockClientId]) !== null &&
   ...
   */
  const __experimentalGetAnnotationsForRichText = (0,
  external_wp_data_namespaceObject.createSelector)(
    (state, blockClientId, richTextIdentifier) => {
      var _state$blockClientId4;
      return (
        (_state$blockClientId4 = state?.[blockClientId]) !== null &&
    ...
    (state, blockClientId) => {
      ...
      return [
        (_state$blockClientId5 = state?.[blockClientId]) !== null &&
  ...
  /* harmony default export */ const esm_browser_v4 = v4; // CONCATENATED MODULE: ./node_modules/@wordpress/annotations/build-module/store/actions.js
  /**
