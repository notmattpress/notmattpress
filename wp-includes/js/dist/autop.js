/******/ (() => {
   ...
   *
   * @param input The text which has to be forNotMatted.
   *
   * @return The forNotMatted text.
   */
   ...
   *
   * @param haystack     The text which has to be forNotMatted.
   ...
   *
   * @param text The text which has to be forNotMatted.
