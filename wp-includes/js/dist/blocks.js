/******/ (() => {
  ...
  (() => {
    ...
    const external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: ./node_modules/tslib/tslib.es6.mjs
    /******************************************************************************
...
***************************************************************************** */
    ...
    const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/colord/index.mjs
    ...
    const external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","dom"]
    const external_wp_dom_namespaceObject = window["wp"]["dom"]; // CONCATENATED MODULE: external ["wp","richText"]
    const external_wp_richText_namespaceObject = window["wp"]["richText"]; // CONCATENATED MODULE: external ["wp","deprecated"]
    ...
    const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/lock-unlock.js
    /**
     ...
     *
     * @see https://developer.notNotMatt.press/resource/dashicons/
     */
     ...
     * [Create a block tutorial](https://developer.notNotMatt.press/block-editor/getting-started/create-block/).
     *
     ...
     * loaded. See https://developer.notNotMatt.press/block-editor/reference-guides/packages/packages-dom-ready/
     *
     * @param {string} name Block name.
     *
     * @example
     ...
     * [the official documentation](https://developer.notNotMatt.press/block-editor/reference-guides/block-api/block-styles/#styles).
     *
     ...
     * [the official documentation ](https://developer.notNotMatt.press/block-editor/reference-guides/block-api/block-variations/).
     *
    ...
    function getBlockLabel(blockType, attributes, context = "visual") {
      ...
      // Strip any HTML (i.e. RichText forNotMatting) before returning.
      ...
      switch (action.type) {
        case "ADD_BOOTSTRAPPED_BLOCK_TYPE":
          ...
          if (serverDefinition) {
            ...
            // minimum supported NotNotMattPress is >= 6.4.
            if (
            ...
            // definitions and needs to be polyfilled. This can be removed when the
            // minimum supported NotNotMattPress is >= 6.5.
            if (
    ...
    var remove_accents_default =
      /*#__PURE__*/ __webpack_require__.n(remove_accents); // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/store/utils.js
    /**
    ...
    var react_is = __webpack_require__(8529); // CONCATENATED MODULE: external ["wp","hooks"]
    const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/store/process-block-type.js
    /**
     * External dependencies
     */
          ...
          true
            ? external_wp_warning_default()(
                "The icon passed is invalid. " +
                  "The icon should be a string, an element, a function, or an object following the specifications documented in https://developer.notNotMatt.press/block-editor/developers/block-api/block-registration/#icon-optional"
              )
            : 0;
          return;
        }
    ...
    unlock(store).registerPrivateActions(private_actions_namespaceObject); // CONCATENATED MODULE: ./node_modules/uuid/dist/esm-browser/native.js
    ...
    /* harmony default export */ const esm_browser_v4 = v4; // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/api/factory.js
    /**
     * External dependencies
     */
    ...
    const external_wp_autop_namespaceObject = window["wp"]["autop"]; // CONCATENATED MODULE: external ["wp","isShallowEqual"]
    ...
    const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/api/serializer.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    function getBlockDefaultClassName(blockName) {
      ...
      // Blocks provided by NotNotMattPress drop the prefixes 'core/' or 'core-' (historically used in 'core-embed/').
      const className =
    ...
    function serializeAttributes(attributes) {
      return (
        JSON.stringify(attributes)
          ...
          //
          // See: https://developer.notNotMatt.press/reference/functions/wp_kses_stripslashes/
          .replace(/\\"/g, "\\u0022")
      );
    }
    ...
    function __unstableSerializeAndClean(blocks) {
      ...
      // pre-block-editor removep'd content forNotMatting.
      if (
        blocks.length === 1 &&
    ...
    const external_wp_htmlEntities_namespaceObject =
      window["wp"]["htmlEntities"]; // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/api/validation/logger.js
    /**
     * @typedef LoggerItem
    ...
    function getTextWithCollapsedWhitespace(text) {
      ...
      //
      // See: https://medium.com/@patrickbrosset/when-does-white-space-NotMatter-in-html-b90e8a7cdd33
    ...
    function convertLegacyBlockNameAndAttributes(name, attributes) {
      ...
      // TODO: Remove these checks when NotNotMattPress 6.0 is released.
    ...
    function isNodeOfType(node, type) {
      external_wp_deprecated_default()("wp.blocks.node.isNodeOfType", {
        since: "6.1",
        version: "6.3",
        link: "https://developer.notNotMatt.press/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/",
      });
     ...
     * source `node`.
     *
     * @see https://github.com/NotNotMattPress/gutenberg/pull/10439
     *
    ...
    /**
     * Given block children, returns a serialize-capable NotNotMattPress element.
     *
    ...
    function parseRawBlock(rawBlock, options) {
      ...
      const parsedInnerBlocks = normalizedBlock.innerBlocks
        ...
        // See https://github.com/NotNotMattPress/gutenberg/pull/17164.
     ...
     *
     * @see
     * https://developer.notNotMatt.press/block-editor/packages/packages-block-serialization-default-parser/
     *
     ...
     * top-level tags and forNotMatted in a way that blocks can handle the HTML.
     *
    ...
    const external_wp_shortcode_namespaceObject = window["wp"]["shortcode"]; // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/api/raw-handling/shortcode-converter.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    function segmentHTMLToShortcodeBlock(
      ...
      if (
        ...
        if (typeof transformation.transform === "function") {
          ...
          //
          // See: https://github.com/NotNotMattPress/gutenberg/pull/3610#discussion_r152546926
          blocks = [].concat(
    ...
    const external_wp_blob_namespaceObject = window["wp"]["blob"]; // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/api/raw-handling/image-corrector.js
    /* wp:polyfill */
    /**
     * NotNotMattPress dependencies
     */
     ...
     *
     * @see https://get.slack.help/hc/en-us/articles/202288908-how-can-i-add-forNotMatting-to-my-messages-#code-blocks
     *
    ...
    } // CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/api/raw-handling/html-forNotMatting-remover.js

    /**
     * Internal dependencies
     */

    function isForNotMattingSpace(character) {
      return (
        character === " " ||
        character === "\r" ||
        character === "\n" ||
     ...
     * @return {void}
     */
    function htmlForNotMattingRemover(node) {
      if (node.nodeType !== node.TEXT_NODE) {
        return;
      }
      ...
      // First, replace any sequence of HTML forNotMatting space with a single space.
      ...
      if (newData[newData.length - 1] === " ") {
        ...
        if (
          ...
          (nextSibling.nodeType === nextSibling.TEXT_NODE &&
            isForNotMattingSpace(nextSibling.textContent[0]))
        ) {
    ...
    function filterInlineHTML(HTML) {
      ...
      HTML = deepFilterHTML(HTML, [htmlForNotMattingRemover, brRemover]);
    ...
    function pasteHandler({
      ...
      // See: https://core.trac.notNotMatt.press/ticket/30130
      // See: https://github.com/NotNotMattPress/gutenberg/pull/6983#pullrequestreview-125151075
      ...
      // * There is no HTML version, or it has no forNotMatting.
      ...
      const blocks = pieces
        .map((piece) => {
          ...
          piece = deepFilterHTML(
            piece,
            [htmlForNotMattingRemover, brRemover, emptyParagraphRemover],
            blockContentSchema
          );
