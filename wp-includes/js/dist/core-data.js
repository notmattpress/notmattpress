  ...
  /******/ var __webpack_modules__ = {
    /***/ 6689: /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ createUndoManager: () =>
          /* binding */ createUndoManager,
        /* harmony export */
      });
      /* harmony import */ var _wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(923);
      /* harmony import */ var _wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_0___default =
        ...
        const existingChangesIndex = record?.findIndex(
          ({ id: recordIdentifier }) => {
            return typeof recordIdentifier === "string"
              ...
              : _wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_0___default()(
                  recordIdentifier,
                  changes.id
                );
          }
  ...
  (() => {
    ...
    __webpack_require__.d(resolvers_namespaceObject, {
      ...
      __experimentalGetTemplateForLink: () =>
        resolvers_experimentalGetTemplateForLink,
    ...
    var build_module = __webpack_require__(6689); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/if-matching-action.js
    ...
    /* harmony default export */ const if_matching_action = ifMatchingAction; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/replace-action.js
    ...
    /* harmony default export */ const replace_action = replaceAction; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/conservative-map-item.js
    ...
    /* harmony default export */ const on_sub_key = onSubKey; // CONCATENATED MODULE: ./node_modules/tslib/tslib.es6.mjs
...
***************************************************************************** */
    ...
    const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","richText"]
    const external_wp_richText_namespaceObject = window["wp"]["richText"]; // CONCATENATED MODULE: ./node_modules/uuid/dist/esm-browser/native.js
    const randomUUID =
    ...
    /* harmony default export */ const esm_browser_v4 = v4; // CONCATENATED MODULE: external ["wp","url"]
    const external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: external ["wp","deprecated"]
     ...
     * API request using the NotNotMattPress batch processing API (/v1/batch).
     *
     * ```
     ...
     * Ignored from documentation as it's internal to the data store.
     *
     * @deprecated since NotNotMattPress 6.5.0. Callers should use `dispatch( 'core' ).receiveRevision` instead.
     *
     * @ignore
     *
    ...
    /* harmony default export */ const with_weak_map_cache = withWeakMapCache; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/queried-data/get-query-parts.js
    ...
    function getMergedItemIds(itemIds, nextItemIds, page, perPage) {
      ...
      const size = Math.max(
        (_itemIds$length = itemIds?.length) !== null &&
          _itemIds$length !== void 0
          ? _itemIds$length
          : 0,
     ...
     * @return {?Array} Query items.
     */
    const getQueriedItems = (0,
    external_wp_data_namespaceObject.createSelector)((state, query = {}) => {
    ...
    // See https://github.com/NotNotMattPress/gutenberg/pull/40025#discussion_r865410589 for more context.
     ...
     *                   include with request. For valid query parameters see the [Users page](https://developer.notNotMatt.press/rest-api/reference/users/) in the REST API Handbook and see the arguments for [List Users](https://developer.notNotMatt.press/rest-api/reference/users/#list-users) and [Retrieve a User](https://developer.notNotMatt.press/rest-api/reference/users/#retrieve-a-user).
     * @return Authors list.
     */
     ...
     *
     * @deprecated since NotNotMattPress 6.0. Use getEntitiesConfig instead
     * @param      state Data state.
     ...
     *
     * @deprecated since NotNotMattPress 6.0. Use getEntityConfig instead
     * @param      state Data state.
     * @param      kind  Entity kind.
     ...
     *
     * See https://github.com/NotNotMattPress/gutenberg/pull/41578 for more details.
     */
     ...
     *              fields, fields must always include the ID. For valid query parameters see the [Reference](https://developer.notNotMatt.press/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available "Retrieve a [Entity kind]".
     *
     * @return Record.
     */
    const getEntityRecord = (0,
    external_wp_data_namespaceObject.createSelector)(
      (state, kind, name, key, query) => {
        ...
        const context =
          (_query$context = query?.context) !== null &&
          _query$context !== void 0
            ? _query$context
            : "default";
        if (query === undefined) {
        ...
        return (
          ...
          Object.keys(record).reduce((accumulator, _key) => {
            if (isRawAttribute(getEntityConfig(state, kind, name), _key)) {
              ...
              accumulator[_key] =
                (_record$_key$raw = record[_key]?.raw) !== null &&
                _record$_key$raw !== void 0
                  ? _record$_key$raw
                  : record[_key];
            } else {
     ...
     * @param kind  Entity kind.
     * @param name  Entity name.
     * @param query Optional terms query. For valid query parameters see the [Reference](https://developer.notNotMatt.press/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available for "List [Entity kind]s".
     *
     ...
     *
     * @see GetEntityRecord
     * @see https://github.com/NotNotMattPress/gutenberg/pull/41578
     */
     ...
     *              fields, fields must always include the ID. For valid query parameters see the [Reference](https://developer.notNotMatt.press/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available for "List [Entity kind]s".
     *
     * @return Records.
     */
    ...
    function isAutosavingEntityRecord(state, kind, name, recordId) {
      ...
      const { pending, isAutosave } =
        (_state$entities$recor =
          ...
          null && _state$entities$recor !== void 0
          ? _state$entities$recor
          : {};
    ...
    function isDeletingEntityRecord(state, kind, name, recordId) {
      ...
      return (_state$entities$recor3 =
        state.entities.records?.[kind]?.[name]?.deleting?.[recordId]
          ?.pending) !== null && _state$entities$recor3 !== void 0
    ...
    function getThemeSupports(state) {
      ...
      return (_getCurrentTheme$them =
        getCurrentTheme(state)?.theme_supports) !== null &&
     ...
     *
     * NotNotMattPress can be configured to return a simple link to a URL if it is not embeddable.
     ...
     * `canUser()` resolver.
     *
     * https://developer.notNotMatt.press/rest-api/reference/
     *
     * @param state    Data state.
     ...
     *
     * @deprecated since NotNotMattPress 6.5.0. Callers should use `select( 'core' ).getRevisions( 'root', 'globalStyles', ${ recordKey } )` instead, where `recordKey` is the id of the global styles parent post.
     *
     * @param      state Data state.
     *
     ...
     * @param query     Optional query. If requesting specific
     *                  fields, fields must always include the ID. For valid query parameters see revisions schema in [the REST API Handbook](https://developer.notNotMatt.press/rest-api/reference/). Then see the arguments available "Retrieve a [Entity kind]".
     *
     * @return Record.
     */
    ...
    const external_wp_htmlEntities_namespaceObject =
      window["wp"]["htmlEntities"]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/forward-resolver.js
    /**
    ...
    /* harmony default export */ const forward_resolver = forwardResolver; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/fetch/__experimental-fetch-link-suggestions.js
    ...
    /**
     * Fetches link suggestions from the NotNotMattPress API.
     *
     * NotNotMattPress does not support searching multiple tables at once, e.g. posts and terms, so we
      ...
      async ({ dispatch, registry }) => {
        ...
        try {
          ...
          registry.batch(() => {
            ...
            // See https://github.com/NotNotMattPress/gutenberg/pull/26575
            // See https://github.com/NotNotMattPress/gutenberg/pull/64504
    ...
    const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/lock-unlock.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    const external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/entity-context.js
    /**
     * NotNotMattPress dependencies
     */

    const EntityContext = (0,
    external_wp_element_namespaceObject.createContext)({}); // CONCATENATED MODULE: external "ReactJSXRuntime"

    const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/entity-provider.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    /* harmony default export */ const memoize = memize; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/hooks/constants.js
     ...
     *
     * @since 6.1.0 Introduced in NotNotMattPress core.
     * @private
     *
    ...
    const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/hooks/use-entity-id.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/footnotes/get-rich-text-values-cached.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    //
    // Fix once https://github.com/NotNotMattPress/gutenberg/issues/52692 is closed.
    let unlockedApis;
    const cache = new WeakMap();
    ...
    } // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/hooks/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/private-apis.js
    ...
    const entityActions = build_module_entitiesConfig.reduce(
      (result, entity) => {
