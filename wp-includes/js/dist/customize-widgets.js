/******/ (() => {
  ...
  (() => {
    ...
    const external_wp_blockLibrary_namespaceObject =
      window["wp"]["blockLibrary"]; // CONCATENATED MODULE: external ["wp","widgets"]
    const external_wp_widgets_namespaceObject = window["wp"]["widgets"]; // CONCATENATED MODULE: external ["wp","blocks"]
    ...
    const external_wp_preferences_namespaceObject = window["wp"]["preferences"]; // CONCATENATED MODULE: external ["wp","components"]
    const external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: external ["wp","i18n"]
    const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","blockEditor"]
    const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: external ["wp","compose"]
    const external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","hooks"]
    const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: external "ReactJSXRuntime"
    const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/error-boundary/index.js
    /**
    ...
    const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: external ["wp","mediaUtils"]
    const external_wp_mediaUtils_namespaceObject = window["wp"]["mediaUtils"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/block-inspector-button/index.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    /* harmony default export */ const block_inspector_button =
      BlockInspectorButton; // CONCATENATED MODULE: ./node_modules/clsx/dist/clsx.mjs
    ...
    /* harmony default export */ const dist_clsx = clsx; // CONCATENATED MODULE: external ["wp","keycodes"]
    const external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // CONCATENATED MODULE: external ["wp","primitives"]
    const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/undo.js
    /**
     * NotNotMattPress dependencies
     */

    const undo = /*#__PURE__*/ (0,
    ...
    /* harmony default export */ const library_redo = redo; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/plus.js

    /**
     * NotNotMattPress dependencies
     */

    const plus = /*#__PURE__*/ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_primitives_namespaceObject.SVG,
      {
        xmlns: "http://www.w3.org/2000/svg",
    ...
    /* harmony default export */ const library_plus = plus; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/close-small.js
    ...
    /* harmony default export */ const close_small = closeSmall; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/store/reducer.js
     ...
     *
     * @see https://github.com/NotNotMattPress/gutenberg/blob/HEAD/packages/data/README.md#registering-a-store
     *
     * @type {Object}
     */
    const storeConfig = {
    ...
    /* harmony default export */ const components_inserter = Inserter; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/more-vertical.js
    ...
    /* harmony default export */ const library_external = external; // CONCATENATED MODULE: external ["wp","keyboardShortcuts"]

    const external_wp_keyboardShortcuts_namespaceObject =
      window["wp"]["keyboardShortcuts"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/config.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    /* harmony default export */ const dynamic_shortcut = DynamicShortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/index.js
                      ...
                      external_ReactJSXRuntime_namespaceObject.jsx)(
                        external_wp_components_namespaceObject.ToolbarButton,
                        {
                          ...
                          /* translators: button label text should, if possible, be under 16 characters. */ label:
                            (0, external_wp_i18n_namespaceObject.__)("Undo"),
                          shortcut:
                      ...
                      external_ReactJSXRuntime_namespaceObject.jsx)(
                        external_wp_components_namespaceObject.ToolbarButton,
                        {
                          icon: !(0, external_wp_i18n_namespaceObject.isRTL)()
                            ...
                            : library_undo,
                          /* translators: button label text should, if possible, be under 16 characters. */ label:
                            (0, external_wp_i18n_namespaceObject.__)("Redo"),
                          shortcut: shortcut,
                          disabled: !hasRedo,
    ...
    /* harmony default export */ const header = Header; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/inserter/use-inserter.js
    ...
    const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/lock-unlock.js
    /**
     * NotNotMattPress dependencies
     */
          ...
          children: [
            /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
              "div",
              {
                ...
                children: /*#__PURE__*/ (0,
                external_ReactJSXRuntime_namespaceObject.jsxs)("picture", {
                  children: [
                    /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)("source", {
                      srcSet:
            ...
            /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
              "p",
              {
                ...
                children: isEntirelyBlockWidgets
                  ? (0, external_wp_i18n_namespaceObject.__)(
    ...
    /* harmony default export */ const keyboard_shortcuts = KeyboardShortcuts; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/block-appender/index.js
            ...
            /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
              SidebarEditorProvider,
              {
                ...
                children: [
                  ...
                  /*#__PURE__*/ (0,
                  external_ReactJSXRuntime_namespaceObject.jsx)(header, {
                    sidebar: sidebar,
                    inserter: inserter,
                    isInserterOpened: isInserterOpened,
                    setIsInserterOpened: setIsInserterOpened,
                  ...
                  /*#__PURE__*/ (0,
                  external_ReactJSXRuntime_namespaceObject.jsx)(BlockCanvas, {
                    shouldIframe: false,
    ...
    function CustomizeWidgets({ api, sidebarControls, blockEditorSettings }) {
      ...
      return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
        ...
        {
          children: /*#__PURE__*/ (0,
          external_ReactJSXRuntime_namespaceObject.jsx)(SidebarControls, {
            sidebarControls: sidebarControls,
            activeSidebarControl: activeSidebarControl,
            children: /*#__PURE__*/ (0,
            external_ReactJSXRuntime_namespaceObject.jsxs)(FocusControl, {
              api: api,
              sidebarControls: sidebarControls,
    ...
    const external_wp_dom_namespaceObject = window["wp"]["dom"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/controls/inserter-outer-section.js
    /**
     * NotNotMattPress dependencies
     */
    ...
    function getInserterOuterSection() {
      ...
      return class InserterOuterSection extends customize.OuterSection {
        constructor(...args) {
          ...
          // @See https://github.com/NotNotMattPress/wordpress-develop/blob/42b05c397c50d9dc244083eff52991413909d4bd/src/js/_enqueues/wp/customize/controls.js#L1427-L1436
      ...
      (BlockEdit) => (props) => {
        ...
        const isWide =
          (_wp$customize$Widgets =
            ...
            )?.is_wide) !== null && _wp$customize$Widgets !== void 0
            ? _wp$customize$Widgets
            : false;
        return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
          BlockEdit,
      ...
      build_module_wp.customize.bind("ready", () => {
        ...
        (0, external_wp_element_namespaceObject.createRoot)(container).render(
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            ...
            {
              children: /*#__PURE__*/ (0,
              external_ReactJSXRuntime_namespaceObject.jsx)(CustomizeWidgets, {
