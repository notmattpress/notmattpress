...
(() => {
  ...
  (() => {
    ...
    function _(e) {
      const t = new WeakMap(),
        r = (...n) => {
          ...
          return (
            o || ((o = e(r.registry.select)), t.set(r.registry, o)), o(...n)
          );
        };
        ...
        for (
          t = (function (e) {
            ...
            t.isUniqueByDependants ||
              (t.lastDependants && !z(c, t.lastDependants, 0) && t.clear(),
              (t.lastDependants = c)),
            o = t.head;
          o;
    ...
    function $(e, t, r) {
      i()("wp.data.select( store ).getIsResolving", {
        since: "6.6",
        version: "6.8",
          ...
          instantiate: (c) => {
            ...
            function m(e, t) {
              ...
              const r = (...t) => {
                ...
                return (
                  e.isRegistrySelector && (e.registry = c), e(r.root, ...t)
                );
              };
    ...
    function me(e = {}, t = null) {
      ...
      function c(e, n) {
        ...
        if (
          ...
          try {
            F(o.store).registerPrivateActions(F(t).privateActionsOf(e)),
              F(o.store).registerPrivateSelectors(F(t).privateSelectorsOf(e));
          } catch (e) {}
        return o;
      }
      let u = {
    ...
    try {
      (Ae = window.localStorage),
        Ae.setItem("__wpDataTestLocalStorage", ""),
        Ae.removeItem("__wpDataTestLocalStorage");
    } catch (e) {
      Ae = Ne;
    }
    const Le = Ae,
      ...
      return {
        registerStore(t, n) {
          ...
          if (void 0 !== o) {
            ...
            (e = Ee(e) && Ee(o) ? Ie()(e, o, { isMergeableObject: Ee }) : o),
              (n = { ...n, initialState: e });
          }
    ...
    const et = window.ReactJSXRuntime,
      ...
      ot = (0, R.createHigherOrderComponent)(
        (e) => (t) =>
          (0, et.jsx)(He, {
            children: (r) => (0, et.jsx)(e, { ...t, registry: r }),
          }),
        "withRegistry"
      ),
      st = (e) => {
