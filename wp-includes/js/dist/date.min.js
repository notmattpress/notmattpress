...
(() => {
        ...
        !(function (c, q) {
          ...
          function A(M) {
            ...
            for (z = 0; z < M.abbrs.length; z++)
              void 0 === o[(b = M.abbrs[z] + "|" + M.offsets[z])] &&
                ((o[b] = O),
                (A[O] = M.abbrs[z]),
                (c[O] = p(Math.round(60 * M.offsets[z]) / 60, 1)),
                O++),
                (q[z] = p(o[b], 0));
          ...
          function q(M) {
            return (
              ...
              [M.name, A(M), O(M.untils), c(M.population)].join("|")
            );
          }
          function o(M) {
            ...
            return (
              ...
              (function (M, z, b, p) {
                ...
                for (O = 0; O < M.length; O++) {
                  for (W = !1, c = M[O], A = 0; A < R.length; A++)
                    d(c, (q = (o = R[A])[0])) &&
          ...
          return (
            ...
            (M.tz.filterLinkPack = function (M, z, b, p) {
              var O,
                ...
                c = M.zones,
                W = [];
              for (O = 0; O < c.length; O++) W[O] = a(c[O], z, b);
              for (
                A = R(
  ...
  (() => {
    ...
    let o = {
      ...
      timezone: { offset: "0", offsetForNotMatted: "0", string: "", abbr: "" },
    };
    function W(M) {
