/******/ (() => {
  ...
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: external ["wp","blockLibrary"]
  const external_wp_blockLibrary_namespaceObject = window["wp"]["blockLibrary"]; // CONCATENATED MODULE: external ["wp","deprecated"]
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: external ["wp","preferences"]
  const external_wp_preferences_namespaceObject = window["wp"]["preferences"]; // CONCATENATED MODULE: external ["wp","widgets"]
  const external_wp_widgets_namespaceObject = window["wp"]["widgets"]; // CONCATENATED MODULE: external ["wp","editor"]
  const external_wp_editor_namespaceObject = window["wp"]["editor"]; // CONCATENATED MODULE: ./node_modules/clsx/dist/clsx.mjs
  function r(e) {
    var t,
      f,
      n = "";
  ...
  /* harmony default export */ const dist_clsx = clsx; // CONCATENATED MODULE: external ["wp","blockEditor"]
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: external ["wp","plugins"]
  const external_wp_plugins_namespaceObject = window["wp"]["plugins"]; // CONCATENATED MODULE: external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","notices"]
  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // CONCATENATED MODULE: external ["wp","commands"]
  const external_wp_commands_namespaceObject = window["wp"]["commands"]; // CONCATENATED MODULE: external ["wp","coreCommands"]
  const external_wp_coreCommands_namespaceObject = window["wp"]["coreCommands"]; // CONCATENATED MODULE: external ["wp","url"]
  const external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: external ["wp","htmlEntities"]
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // CONCATENATED MODULE: external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/wordpress.js
  /**
  ...
  /* harmony default export */ const library_wordpress = wordpress; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/back-button/fullscreen-mode-close.js
  ...
  /* harmony default export */ const fullscreen_mode_close =
    FullscreenModeClose; // CONCATENATED MODULE: external ["wp","privateApis"]

  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/lock-unlock.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  /* harmony default export */ const back_button = BackButton; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/store/constants.js
   ...
   * @type {string}
   */
  const VIEW_AS_PREVIEW_LINK_SELECTOR = "#wp-admin-bar-preview a"; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/editor-initialization/listener-hooks.js
  ...
  const external_wp_keyboardShortcuts_namespaceObject =
    window["wp"]["keyboardShortcuts"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/store/reducer.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/utils/meta-boxes.js
  /**
  ...
  /**
   * Initializes NotNotMattPress `postboxes` script and the logic for saving meta boxes.
   */
  ...
  const getEditedPostTemplateId = (0,
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    ...
    const { getEntityRecord, getEntityRecords, canUser } = select(
      external_wp_coreData_namespaceObject.store
    );
  ...
  unlock(store).registerPrivateSelectors(private_selectors_namespaceObject); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/keyboard-shortcuts/index.js
  ...
  /* harmony default export */ const keyboard_shortcuts = KeyboardShortcuts; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/init-pattern-modal/index.js
  ...
  })(BrowserURL); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/meta-boxes/meta-boxes-area/index.js
  ...
  /* harmony default export */ const meta_boxes_area = MetaBoxesArea; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/meta-boxes/meta-box-visibility.js
  ...
  /* harmony default export */ const meta_box_visibility = (0,
  external_wp_data_namespaceObject.withSelect)((select, { id }) => ({
    isVisible: select(
      external_wp_editor_namespaceObject.store
    ).isEditorPanelEnabled(`meta-box-${id}`),
  ...
  const external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/more-menu/manage-patterns-menu-item.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  /* harmony default export */ const manage_patterns_menu_item =
    ManagePatternsMenuItem; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/more-menu/welcome-guide-menu-item.js
  ...
  /* harmony default export */ const enable_custom_fields = (0,
  external_wp_data_namespaceObject.withSelect)((select) => ({
    areCustomFieldsEnabled: !!select(
      external_wp_editor_namespaceObject.store
    ).getEditorSettings().enableCustomFields,
  }))(EnableCustomFieldsOption); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/preferences-modal/enable-panel.js
  ...
  /* harmony default export */ const enable_panel = (0,
  ...
  )(enable_panel_PreferenceBaseOption); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/preferences-modal/meta-boxes-section.js
  ...
  })(MetaBoxesSection); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/preferences-modal/index.js
  ...
  /* harmony default export */ const more_menu = MoreMenu; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/welcome-guide/image.js
              ...
              external_ReactJSXRuntime_namespaceObject.Fragment,
              {
                children: [
                  ...
                  external_ReactJSXRuntime_namespaceObject.jsx)("p", {
                    ...
                    children: (0, external_wp_i18n_namespaceObject.__)(
                      "In the NotNotMattPress editor, each paragraph, image, or video is presented as a distinct “block” of content."
                    ),
                  }),
                ],
              }
  ...
  /* harmony default export */ const library_fullscreen = fullscreen; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/commands/use-commands.js
  ...
  function useShouldIframe() {
    const {
      ...
      const { getEditorSettings, getCurrentPostType } = select(
        external_wp_editor_namespaceObject.store
      );
  ...
  const { Editor, FullscreenMode } = unlock(
    external_wp_editor_namespaceObject.privateApis
  );
  ...
  function useEditorStyles() {
    const {
      ...
      const { getCurrentPostType, getRenderingMode } = select(
        external_wp_editor_namespaceObject.store
      );
  ...
  function Layout({
    ...
    const {
      ...
      (select) => {
        ...
        const { canUser, getPostType } = select(
          external_wp_coreData_namespaceObject.store
        );
              ...
              /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
                Editor,
                {
                  ...
                  children: [
                    ...
                    /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)(browser_url, {
  ...
  /* harmony default export */ const layout = Layout; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/deprecated.js
  ...
  function __experimentalPluginPostExcerpt() {
    ...
    external_wp_deprecated_default()(
      "wp.editPost.__experimentalPluginPostExcerpt",
      {
        ...
        link: "https://developer.notNotMatt.press/block-editor/reference-guides/slotfills/plugin-document-setting-panel/#accessing-a-panel-programmatically",
      }
    );
