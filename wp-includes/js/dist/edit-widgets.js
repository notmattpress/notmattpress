/******/ (() => {
  ...
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: external ["wp","deprecated"]
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","blockLibrary"]
  const external_wp_blockLibrary_namespaceObject = window["wp"]["blockLibrary"]; // CONCATENATED MODULE: external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: external ["wp","widgets"]
  const external_wp_widgets_namespaceObject = window["wp"]["widgets"]; // CONCATENATED MODULE: external ["wp","preferences"]
  const external_wp_preferences_namespaceObject = window["wp"]["preferences"]; // CONCATENATED MODULE: external ["wp","apiFetch"]
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","notices"]
  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // CONCATENATED MODULE: ./node_modules/clsx/dist/clsx.mjs
  function r(e) {
    var t,
      f,
      n = "";
  ...
  /* harmony default export */ const dist_clsx = clsx; // CONCATENATED MODULE: external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/check.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  /* harmony default export */ const library_check = check; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/star-filled.js
  ...
  /* harmony default export */ const star_filled = starFilled; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/star-empty.js
  ...
  /* harmony default export */ const star_empty = starEmpty; // CONCATENATED MODULE: external ["wp","viewport"]

  const external_wp_viewport_namespaceObject = window["wp"]["viewport"]; // CONCATENATED MODULE: external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/close-small.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  /* harmony default export */ const close_small = closeSmall; // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/store/deprecated.js
   ...
   *
   * @see https://github.com/NotNotMattPress/gutenberg/blob/HEAD/packages/data/README.md#createReduxStore
   *
   * @type {Object}
   */
  ...
  const external_wp_plugins_namespaceObject = window["wp"]["plugins"]; // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/components/complementary-area-context/index.js
  /**
   * NotNotMattPress dependencies
   */

  /* harmony default export */ const complementary_area_context = (0,
  ...
  /* harmony default export */ const complementary_area_toggle =
  ...
  const ComplementaryAreaHeader = ({
    ...
    external_ReactJSXRuntime_namespaceObject.jsx)(complementary_area_toggle, {
      icon: close_small,
      ...toggleButtonProps,
    });
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_components_namespaceObject.Slot,
      {
        ...
        children: (fills) => {
          ...
          // @see https://github.com/NotNotMattPress/gutenberg/issues/14457
  ...
  /* harmony default export */ const action_item = ActionItem; // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/components/complementary-area-more-menu-item/index.js
  ...
  /* harmony default export */ const pinned_items = PinnedItems; // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/components/complementary-area/index.js
  ...
  /* harmony default export */ const complementary_area =
    ComplementaryAreaWrapped; // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/components/navigable-region/index.js
  ...
  external_wp_element_namespaceObject.forwardRef)(InterfaceSkeleton); // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/components/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/index.js // CONCATENATED MODULE: external ["wp","blockEditor"]

  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/store/transformers.js
  /**
   * NotNotMattPress dependencies
   */
   ...
   * @return {Object} A stub post object forNotMatted in compliance with the data layer.
   */
  ...
  const saveWidgetArea =
    ...
    async ({ dispatch, select, registry }) => {
      ...
      // implemented using a function. NotNotMattPress doesn't support having more than one instance of these, if you try to
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/lock-unlock.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  external_wp_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)(
    "I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of NotNotMattPress.",
   ...
   *
   * @see https://github.com/NotNotMattPress/gutenberg/blob/HEAD/packages/data/README.md#register
   *
   * @type {Object}
   */
  const storeConfig = {
  ...
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/filters/move-to-widget-area.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  const external_wp_mediaUtils_namespaceObject = window["wp"]["mediaUtils"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/filters/replace-media-upload.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  const external_wp_patterns_namespaceObject = window["wp"]["patterns"]; // CONCATENATED MODULE: external ["wp","keyboardShortcuts"]
  const external_wp_keyboardShortcuts_namespaceObject =
    window["wp"]["keyboardShortcuts"]; // CONCATENATED MODULE: external ["wp","keycodes"]
  const external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcuts/index.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  /* harmony default export */ const keyboard_shortcuts = KeyboardShortcuts; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/hooks/use-last-selected-widget-area.js
  ...
  const ENABLE_EXPERIMENTAL_FSE_BLOCKS = false; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/widget-areas-block-editor-provider/index.js
  ...
  /* harmony default export */ const drawer_left = drawerLeft; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/drawer-right.js
  ...
  /* harmony default export */ const drawer_right = drawerRight; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/block-default.js
  ...
  /* harmony default export */ const block_default = blockDefault; // CONCATENATED MODULE: external ["wp","url"]

  const external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: external ["wp","dom"]
  const external_wp_dom_namespaceObject = window["wp"]["dom"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/sidebar/widget-areas.js
  /**
   * NotNotMattPress dependencies
   */
              ...
              "div",
              {
                children: [
                  ...
                  external_ReactJSXRuntime_namespaceObject.jsx)("p", {
                    ...
                    // established feature of NotNotMattPress.
                    // @see https://github.com/NotNotMattPress/gutenberg/issues/33106
  ...
  /* harmony default export */ const library_plus = plus; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/list-view.js
  ...
  /* harmony default export */ const list_view = listView; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/undo.js
  ...
  /* harmony default export */ const library_undo = undo; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/redo.js
  ...
  /* harmony default export */ const library_redo = redo; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/header/undo-redo/undo.js
  ...
  function UndoButton(props, ref) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_components_namespaceObject.Button,
      {
        ...
        // See: https://github.com/NotNotMattPress/gutenberg/issues/3486
  ...
  external_wp_element_namespaceObject.forwardRef)(UndoButton); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/header/undo-redo/redo.js
  ...
  external_wp_element_namespaceObject.forwardRef)(RedoButton); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/header/document-tools/index.js
  ...
  /* harmony default export */ const document_tools = DocumentTools; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/save-button/index.js
  ...
  /* harmony default export */ const save_button = SaveButton; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/more-vertical.js
  ...
  /* harmony default export */ const more_vertical = moreVertical; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/external.js
  ...
  /* harmony default export */ const library_external = external; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcut-help-modal/config.js

  /**
   * NotNotMattPress dependencies
   */

  const textForNotMattingShortcuts = [
    {
      keyCombination: {
        modifier: "primary",
        character: "b",
  ...
  /* harmony default export */ const dynamic_shortcut = DynamicShortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcut-help-modal/index.js
        ...
        children: [
          ...
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            ShortcutSection,
            {
              ...
              shortcuts: textForNotMattingShortcuts,
            }
          ),
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            ShortcutCategorySection,
  ...
  /* harmony default export */ const tools_more_menu_group = ToolsMoreMenuGroup; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/more-menu/index.js
                            ...
                            external_ReactJSXRuntime_namespaceObject.jsxs)(
                              external_wp_components_namespaceObject.MenuItem,
                              {
                                ...
                                href: (0, external_wp_i18n_namespaceObject.__)(
                                  "https://notNotMatt.press/documentation/article/block-based-widgets-editor/"
                                ),
                                target: "_blank",
  ...
  /* harmony default export */ const header = Header; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/notices/index.js
  ...
  /* harmony default export */ const notices = Notices; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/widget-areas-block-editor-content/index.js
  ...
  /* harmony default export */ const library_close = close_close; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/hooks/use-widget-library-insertion-point.js
  ...
  /* harmony default export */ const layout_interface = Interface; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/layout/unsaved-changes-warning.js
                                ...
                                children: [
                                  ...
                                  external_ReactJSXRuntime_namespaceObject.jsx)(
                                    external_wp_components_namespaceObject.ExternalLink,
                                    {
                                      href: (0,
                                      external_wp_i18n_namespaceObject.__)(
                                        "https://notNotMatt.press/plugins/classic-widgets/"
                                      ),
                                      children: (0,
                                      external_wp_i18n_namespaceObject.__)(
                    ...
                    external_wp_element_namespaceObject.createInterpolateElement)(
                      ...
                      ),
                      {
                        ...
                        external_ReactJSXRuntime_namespaceObject.jsx)(
                          ...
                          {
                            href: (0, external_wp_i18n_namespaceObject.__)(
                              "https://notNotMatt.press/documentation/article/wordpress-block-editor/"
                            ),
                          }
                        ),
                      }
  ...
  /* harmony default export */ const layout = Layout; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/index.js
  ...
  function initializeEditor(id, settings) {
    ...
    // see: https://github.com/NotNotMattPress/gutenberg/issues/33097
