/******/ (() => {
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","htmlEntities"]
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/utils.js
  /**
  ...
  function isTemplateRemovable(template) {
    ...
    return (
      [template.source, template.source].includes(TEMPLATE_ORIGINS.custom) &&
  ...
  /* harmony default export */ const title = titleField; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/fields/order/index.js
  ...
  /* harmony default export */ const order = orderField; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/fields/index.js // CONCATENATED MODULE: external ["wp","primitives"]

  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/external.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  /* harmony default export */ const library_external = external; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/base-post/view-post.js
  ...
  /* harmony default export */ const view_post = viewPost; // CONCATENATED MODULE: external ["wp","data"]

  const external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: external ["wp","notices"]
  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // CONCATENATED MODULE: external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: ./node_modules/@wordpress/dataviews/build-module/field-types/integer.js
  /**
   * Internal dependencies
   */
  ...
  const external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: ./node_modules/@wordpress/dataviews/build-module/dataform-controls/datetime.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  function DateTime({ data, field, onChange, hideLabelFromVision }) {
    const { id, label } = field;
    const value = field.getValue({
      item: data,
    });
    const onChangeControl = (0,
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
      "fieldset",
      {
        ...
        children: [
          ...
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            external_wp_components_namespaceObject.TimePicker,
            {
              currentTime: value,
  ...
  function Integer({ data, field, onChange, hideLabelFromVision }) {
    var _field$getValue;
    const { id, label, description } = field;
    const value =
      (_field$getValue = field.getValue({
        item: data,
      })) !== null && _field$getValue !== void 0
        ? _field$getValue
        : "";
    const onChangeControl = (0,
    external_wp_element_namespaceObject.useCallback)(
  ...
  function Radio({ data, field, onChange, hideLabelFromVision }) {
    const { id, label } = field;
    const value = field.getValue({
      item: data,
    });
  ...
  function Select({ data, field, onChange, hideLabelFromVision }) {
    ...
    const elements = [
      ...
      ...((_field$elements = field?.elements) !== null &&
      _field$elements !== void 0
        ? _field$elements
        : []),
    ];
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
  ...
  function Text({ data, field, onChange, hideLabelFromVision }) {
  ...
  function normalizeFields(fields) {
    return fields.map((field) => {
      var _field$sort,
        _field$isValid,
        _field$enableHiding,
        _field$enableSorting;
      const fieldTypeDefinition = getFieldTypeDefinition(field.type);
      const getValue = field.getValue || (({ item }) => item[field.id]);
      const sort =
        (_field$sort = field.sort) !== null && _field$sort !== void 0
          ? _field$sort
          : function sort(a, b, direction) {
      ...
      const isValid =
        (_field$isValid = field.isValid) !== null && _field$isValid !== void 0
          ? _field$isValid
      ...
      return {
        ...
        Edit,
        enableHiding:
          (_field$enableHiding = field.enableHiding) !== null &&
          _field$enableHiding !== void 0
            ? _field$enableHiding
            : true,
        enableSorting:
          (_field$enableSorting = field.enableSorting) !== null &&
          _field$enableSorting !== void 0
            ? _field$enableSorting
            : true,
      };
    });
  ...
  function FormRegular({ data, fields, form, onChange }) {
    const visibleFields = (0,
    external_wp_element_namespaceObject.useMemo)(() => {
      var _form$fields;
      return normalizeFields(
        ((_form$fields = form.fields) !== null && _form$fields !== void 0
          ? _form$fields
          : []
        )
  ...
  /* harmony default export */ const close_small = closeSmall; // CONCATENATED MODULE: ./node_modules/@wordpress/dataviews/build-module/dataforms-layouts/panel/index.js
  ...
  function FormField({ data, field, onChange }) {
  ...
  function FormPanel({ data, fields, form, onChange }) {
    const visibleFields = (0,
    external_wp_element_namespaceObject.useMemo)(() => {
      var _form$fields;
      return normalizeFields(
  ...
  function DataForm({ form, ...props }) {
    var _form$type;
    const layout = getFormLayout(
      (_form$type = form.type) !== null && _form$type !== void 0
        ? _form$type
        : "regular"
    );
    if (!layout) {
  ...
  function ReorderModal({ items, closeModal, onActionPerformed }) {
    ...
    async function onOrder(event) {
      ...
      try {
        ...
        createSuccessNotice(
          (0, external_wp_i18n_namespaceObject.__)("Order updated."),
          {
            type: "snackbar",
          }
        );
  ...
  /* harmony default export */ const reorder_page = reorderPage; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/base-post/reorder-page.native.js

  const reorder_page_native_reorderPage = undefined;
  /* harmony default export */ const reorder_page_native =
    reorder_page_native_reorderPage; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/base-post/duplicate-post.js
    ...
    RenderModal: ({ items, closeModal, onActionPerformed }) => {
      const [item, setItem] = (0, external_wp_element_namespaceObject.useState)(
        {
          ...
          title: (0, external_wp_i18n_namespaceObject.sprintf)(
            ...
            (0, external_wp_i18n_namespaceObject.__)("%s (Copy)"),
      ...
      async function createPage(event) {
        ...
        const newItemOject = {
          ...
          title: item.title,
          slug:
            item.title || (0, external_wp_i18n_namespaceObject.__)("No title"),
        ...
        const assignableProperties = Object.keys(item?._links || {})
          .filter((property) => property.startsWith(assignablePropertiesPrefix))
          .map((property) => property.slice(assignablePropertiesPrefix.length));
  ...
  /* harmony default export */ const duplicate_post = duplicatePost; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/base-post/duplicate-post.native.js

  const duplicate_post_native_duplicatePost = undefined;
  /* harmony default export */ const duplicate_post_native =
    duplicate_post_native_duplicatePost; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/base-post/index.js // CONCATENATED MODULE: external ["wp","url"]

  const external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/common/view-post-revisions.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  const viewPostRevisions = {
    ...
    label(items) {
      ...
      const revisionsCount =
        (_items$0$_links$versi =
          items[0]._links?.["version-history"]?.[0]?.count) !== null &&
        _items$0$_links$versi !== void 0
          ? _items$0$_links$versi
          : 0;
      return (0, external_wp_i18n_namespaceObject.sprintf)(
        /* translators: %s: number of revisions */
        (0, external_wp_i18n_namespaceObject.__)("View revisions (%s)"),
        revisionsCount
      );
    },
    isEligible(post) {
      ...
      const lastRevisionId =
        (_post$_links$predeces =
          post?._links?.["predecessor-version"]?.[0]?.id) !== null &&
        _post$_links$predeces !== void 0
          ? _post$_links$predeces
          : null;
      const revisionsCount =
        (_post$_links$version =
          post?._links?.["version-history"]?.[0]?.count) !== null &&
        _post$_links$version !== void 0
          ? _post$_links$version
          : 0;
    ...
    callback(posts, { onActionPerformed }) {
      const post = posts[0];
      const href = (0, external_wp_url_namespaceObject.addQueryArgs)(
        "revision.php",
        {
  ...
  /* harmony default export */ const view_post_revisions = viewPostRevisions; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/trash.js

  /**
   * NotNotMattPress dependencies
   */

  const trash = /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
  ...
  /* harmony default export */ const library_trash = trash; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/common/permanently-delete-post.js
  ...
  const permanentlyDeletePost = {
    ...
    async callback(posts, { registry, onActionPerformed }) {
      const { createSuccessNotice, createErrorNotice } = registry.dispatch(
        external_wp_notices_namespaceObject.store
      );
      const { deleteEntityRecord } = registry.dispatch(
        external_wp_coreData_namespaceObject.store
      );
  ...
  /* harmony default export */ const permanently_delete_post =
    permanentlyDeletePost; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/common/index.js // CONCATENATED MODULE: external ["wp","patterns"]

  const external_wp_patterns_namespaceObject = window["wp"]["patterns"]; // CONCATENATED MODULE: external ["wp","privateApis"]
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/lock-unlock.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  const duplicatePattern = {
    ...
    modalHeader: (0, external_wp_i18n_namespaceObject._x)(
      "Duplicate pattern",
      "action label"
    ),
    RenderModal: ({ items, closeModal }) => {
      ...
      return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
        ...
        {
          onClose: closeModal,
          confirmLabel: (0, external_wp_i18n_namespaceObject._x)(
            "Duplicate",
            "action label"
          ),
          ...duplicatedProps,
  ...
  /* harmony default export */ const duplicate_pattern = duplicatePattern; // CONCATENATED MODULE: ./node_modules/tslib/tslib.es6.mjs
...
***************************************************************************** */
    ...
    return o(
      (async function* (t, f) {
        ...
        for await (const e of t) {
          const n = B(e, f.buffersAreUTF8);
          yield p(e, n), yield new Uint8Array(e.o), e.isFile && (yield* g(e));
  ...
  const external_wp_blob_namespaceObject = window["wp"]["blob"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/download.js
  /**
   * NotNotMattPress dependencies
   */

  const download = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
  ...
  /* harmony default export */ const library_download = download; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/pattern/export-pattern.js
    ...
    callback: async (items) => {
      if (items.length === 1) {
        return (0, external_wp_blob_namespaceObject.downloadBlob)(
          `${paramCase(getItemTitle(items[0]) || items[0].slug)}.json`,
      ...
      const filesToZip = items.map((item) => {
        ...
        return {
          name: `${
            name + (nameCount[name] > 1 ? "-" + (nameCount[name] - 1) : "")
          }.json`,
  ...
  /* harmony default export */ const export_pattern = exportPattern; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/pattern/export-pattern.native.js

  const export_pattern_native_exportPattern = undefined;
  /* harmony default export */ const export_pattern_native =
    export_pattern_native_exportPattern; // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/pattern/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/actions/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/fields/build-module/index.js
