/******/ (() => {
  ...
  __webpack_require__.d(__webpack_exports__, {
    ...
    transforNotMattachment: () => /* reexport */ transforNotMattachment,
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/components/media-upload/index.js
  /**
  ...
  /* harmony default export */ const media_upload = MediaUpload; // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/components/index.js // CONCATENATED MODULE: external ["wp","blob"]

  const external_wp_blob_namespaceObject = window["wp"]["blob"]; // CONCATENATED MODULE: external ["wp","apiFetch"]
   ...
   */
  function transforNotMattachment(attachment) {
