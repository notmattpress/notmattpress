/******/ (() => {
  ...
  const external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/store/reducer.js
  /**
  ...
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: external ["wp","blockEditor"]
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/constants.js
  const PATTERN_TYPES = {
    theme: "pattern",
    user: "wp_block",
  };
  ...
  const PATTERN_OVERRIDES_BINDING_SOURCE = "core/pattern-overrides"; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/store/actions.js
   ...
   * Module Constants
   */
  const STORE_NAME = "core/patterns"; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/store/selectors.js
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/lock-unlock.js
  /**
   * NotNotMattPress dependencies
   */
   ...
   *
   * @see https://github.com/NotNotMattPress/gutenberg/blob/HEAD/packages/data/README.md#registerStore
   *
   * @type {Object}
   */
  const storeConfig = {
  ...
  unlock(store).registerPrivateSelectors(selectors_namespaceObject); // CONCATENATED MODULE: external ["wp","components"]

  const external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/api/index.js
  /**
   * Internal dependencies
   */
  ...
  function isOverridableBlock(block) {
    return (
      Object.keys(PARTIAL_SYNCING_SUPPORTED_BLOCKS).includes(block.name) &&
  ...
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/overrides-panel.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  const { BlockQuickNavigation } = unlock(
  ...
  function OverridesPanel() {
    ...
    const clientIdsWithOverrides = (0,
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_components_namespaceObject.PanelBody,
      {
        ...
        children: /*#__PURE__*/ (0,
        external_ReactJSXRuntime_namespaceObject.jsx)(BlockQuickNavigation, {
  ...
  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // CONCATENATED MODULE: external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","htmlEntities"]
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/category-selector.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  function CategorySelector({ categoryTerms, onChange, categoryMap }) {
    ...
    function handleChange(termNames) {
      const uniqueTerms = termNames.reduce((terms, newTerm) => {
        if (
          !terms.some((term) => term.toLowerCase() === newTerm.toLowerCase())
        ) {
          terms.push(newTerm);
        }
        return terms;
  ...
  function useAddPatternCategory() {
    const { saveEntityRecord, invalidateResolution } = (0,
    external_wp_data_namespaceObject.useDispatch)(
      external_wp_coreData_namespaceObject.store
    );
    const { corePatternCategories, userPatternCategories } = (0,
    external_wp_data_namespaceObject.useSelect)((select) => {
      const { getUserPatternCategories, getBlockPatternCategories } = select(
        external_wp_coreData_namespaceObject.store
      );
      return {
  ...
  function CreatePatternModalContents({
    ...
    external_wp_element_namespaceObject.useState)(defaultSyncType);
    const [categoryTerms, setCategoryTerms] = (0,
    external_wp_element_namespaceObject.useState)(defaultCategories);
    const [title, setTitle] = (0, external_wp_element_namespaceObject.useState)(
      defaultTitle
    );
    const [isSaving, setIsSaving] = (0,
    external_wp_element_namespaceObject.useState)(false);
    const { createPattern } = unlock(
    ...
    async function onCreate(patternTitle, sync) {
      ...
      try {
        ...
        const categories = await Promise.all(
          categoryTerms.map((termName) => findOrCreateTerm(termName))
        );
  ...
  function getTermLabels(pattern, categories) {
    ...
    if (pattern.type !== PATTERN_TYPES.user) {
      return categories.core
        ?.filter((category) => pattern.categories.includes(category.name))
        .map((category) => category.label);
    }
    return categories.user
      ?.filter((category) => pattern.wp_pattern_category.includes(category.id))
      .map((category) => category.label);
  }
  function useDuplicatePatternProps({ pattern, onSuccess }) {
    ...
    const categories = (0, external_wp_data_namespaceObject.useSelect)(
      (select) => {
        const { getUserPatternCategories, getBlockPatternCategories } = select(
          external_wp_coreData_namespaceObject.store
        );
      ...
      onSuccess: ({ pattern: newPattern }) => {
        createSuccessNotice(
          (0, external_wp_i18n_namespaceObject.sprintf)(
            ...
            (0, external_wp_i18n_namespaceObject.__)('"%s" duplicated.'),
  ...
  function DuplicatePatternModal({ pattern, onClose, onSuccess }) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      CreatePatternModal,
      {
        modalTitle: (0, external_wp_i18n_namespaceObject.__)(
          "Duplicate pattern"
        ),
  ...
  function RenamePatternModal({
    ...
    external_wp_htmlEntities_namespaceObject.decodeEntities)(pattern.title);
    ...
    const onRename = async (event) => {
      ...
      try {
        ...
        createSuccessNotice(
          (0, external_wp_i18n_namespaceObject.__)("Pattern renamed"),
          {
            type: "snackbar",
            id: "pattern-update",
          }
  ...
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/symbol.js
  /**
   * NotNotMattPress dependencies
   */

  const symbol = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
  ...
  /* harmony default export */ const library_symbol = symbol; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/pattern-convert-button.js
  ...
  function PatternConvertButton({
    ...
    const { replaceBlocks } = (0, external_wp_data_namespaceObject.useDispatch)(
      external_wp_blockEditor_namespaceObject.store
    );
    // Ignore reason: false positive of the lint rule.
    // eslint-disable-next-line @wordpress/no-unused-vars-before-return
    const { setEditingPattern } = unlock(
      (0, external_wp_data_namespaceObject.useDispatch)(store)
    );
  ...
  const external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/patterns-manage-button.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  function PatternsManageButton({ clientId }) {
    const { canRemove, isVisible, managePatternsUrl } = (0,
    external_wp_data_namespaceObject.useSelect)(
      (select) => {
  ...
  /* harmony default export */ const patterns_manage_button =
    PatternsManageButton; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/index.js
  ...
  function PatternsMenuItems({ rootClientId }) {
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      ...
      {
        children: ({ selectedClientIds, onClose }) =>
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
            external_ReactJSXRuntime_namespaceObject.Fragment,
            {
              children: [
  ...
  const external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/rename-pattern-category-modal.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  function RenamePatternCategoryModal({
    ...
    const onSave = async (event) => {
      ...
      try {
        ...
        onClose();
        createSuccessNotice(
          (0, external_wp_i18n_namespaceObject.__)("Pattern category renamed."),
          {
            type: "snackbar",
  ...
  function AllowOverridesModal({
    ...
    const [editedBlockName, setEditedBlockName] = (0,
    external_wp_element_namespaceObject.useState)(initialName);
  ...
  function PatternOverridesControls({
    ...
    const { updateBlockBindings } = (0,
    external_wp_blockEditor_namespaceObject.useBlockBindingsUtils)();
  ...
  /* harmony default export */ const pattern_overrides_controls =
    PatternOverridesControls; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/reset-overrides-control.js
  ...
  function ResetOverridesControl(props) {
    ...
    const isOverriden = (0, external_wp_data_namespaceObject.useSelect)(
      (select) => {
        if (!name) {
          return;
        }
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_blockEditor_namespaceObject.__unstableBlockToolbarLastItem,
      {
        children: /*#__PURE__*/ (0,
        external_ReactJSXRuntime_namespaceObject.jsx)(
  ...
  const copy = /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
  ...
  /* harmony default export */ const library_copy = copy; // CONCATENATED MODULE: ./node_modules/@wordpress/patterns/build-module/components/pattern-overrides-block-controls.js
  ...
  const { useBlockDisplayTitle } = unlock(
    external_wp_blockEditor_namespaceObject.privateApis
  );
  function PatternOverridesToolbarIndicator({ clientIds }) {
    const isSingleBlockSelected = clientIds.length === 1;
    const { icon, firstBlockName } = (0,
    external_wp_data_namespaceObject.useSelect)(
      (select) => {
        const { getBlockAttributes, getBlockNamesByClientId } = select(
          external_wp_blockEditor_namespaceObject.store
        );
                ...
                external_ReactJSXRuntime_namespaceObject.Fragment,
                {
                  ...
                  external_ReactJSXRuntime_namespaceObject.jsx)(
                    external_wp_blockEditor_namespaceObject.BlockIcon,
                    {
                      icon: icon,
                      className:
                        "patterns-pattern-overrides-toolbar-indicator-icon",
                      showColors: true,
                    }
                  ),
                }
  ...
  function PatternOverridesBlockControls() {
    const { clientIds, hasPatternOverrides, hasParentPattern } = (0,
    external_wp_data_namespaceObject.useSelect)((select) => {
      const {
        getBlockAttributes,
      ...
      const _hasPatternOverrides = selectedClientIds.every((clientId) => {
        ...
        return Object.values(
          (_getBlockAttributes$m =
            getBlockAttributes(clientId)?.metadata?.bindings) !== null &&
            _getBlockAttributes$m !== void 0
            ? _getBlockAttributes$m
            : {}
        ).some(
      ...
      const _hasParentPattern = selectedClientIds.every(
        (clientId) =>
          getBlockParentsByBlockName(clientId, "core/block", true).length > 0
      );
      return {
        clientIds: selectedClientIds,
