/******/ (() => {
  ...
  __webpack_require__.d(__webpack_exports__, {
    __unstableCreatePersistenceLayer: () =>
      /* binding */ __unstableCreatePersistenceLayer,
  ...
  /**
   * Creates a persistence layer that stores data in NotNotMattPress user meta via the
   * REST API.
   *
   ...
   *
   * @return {Object} A persistence layer for NotNotMattPress user meta.
   */
  function create({
    preloadedData,
   ...
   */
  function moveIndividualPreferenceToPreferences(
    state,
  ...
  function moveInterfaceEnableItems(state) {
    ...
    const allPreferences =
      (_state$preferencesSto = state?.[preferencesStoreName]?.preferences) !==
        null && _state$preferencesSto !== void 0
    ...
    const sourceComplementaryAreas =
      (_sourceEnableItems$si =
        sourceEnableItems?.singleEnableItems?.complementaryArea) !== null &&
    ...
    const sourcePinnedItems =
      (_sourceEnableItems$mu =
        sourceEnableItems?.multipleEnableItems?.pinnedItems) !== null &&
  ...
  function convertEditPostPanels(preferences) {
    ...
    const panels =
      (_preferences$panels = preferences?.panels) !== null &&
      _preferences$panels !== void 0
        ? _preferences$panels
        : {};
  ...
  function convertEditorSettings(data) {
    ...
    if (
      Object.keys(
        (_newData$coreEditPo = newData?.["core/edit-post"]) !== null &&
          _newData$coreEditPo !== void 0
          ? _newData$coreEditPo
          : {}
      )?.length === 0
    ) {
    ...
    if (
      Object.keys(
        (_newData$coreEditSi = newData?.["core/edit-site"]) !== null &&
          _newData$coreEditSi !== void 0
          ? _newData$coreEditSi
          : {}
      )?.length === 0
    ) {
   ...
   *
   * This function is used internally by NotNotMattPress in an inline script, so
