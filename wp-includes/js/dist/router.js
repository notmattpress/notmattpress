/******/ (() => {
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
  ...
  const external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: ./node_modules/@wordpress/router/build-module/history.js
  /* wp:polyfill */
  /**
  ...
  function push(params, state) {
    const search = (0, external_wp_url_namespaceObject.buildQueryString)(
      preserveThemePreview(params)
    );
  ...
  /* harmony default export */ const build_module_history = history_history; // CONCATENATED MODULE: external "ReactJSXRuntime"

  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/router/build-module/router.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  function RouterProvider({ children }) {
    ...
    external_wp_element_namespaceObject.useSyncExternalStore)(
      build_module_history.listen,
      build_module_history.getLocationWithParams,
      build_module_history.getLocationWithParams
    );
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/router/build-module/lock-unlock.js
  /**
   * NotNotMattPress dependencies
   */
