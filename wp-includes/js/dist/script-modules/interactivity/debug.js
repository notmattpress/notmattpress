/******/ var __webpack_modules__ = {
  /***/ 380: /***/ (
    ...
    var preact_module = __webpack_require__(622); // CONCATENATED MODULE: ./node_modules/preact/hooks/dist/hooks.module.js
    var hooks_module_t,
      r,
      hooks_module_u,
      i,
    ...
    function y(n, u) {
      var i = d(hooks_module_t++, 3);
      !hooks_module_c.__s &&
        C(i.__H, u) &&
        ((i.__ = n), (i.i = u), r.__H.__h.push(i));
    }
    function _(n, u) {
      var i = d(hooks_module_t++, 4);
      !hooks_module_c.__s &&
        C(i.__H, u) &&
        ((i.__ = n), (i.i = u), r.__h.push(i));
    }
    function A(n) {
      return (
        (hooks_module_o = 5),
    ...
    function signals_module_l(n, i) {
      preact_module /* options */.fF[n] = i.bind(
        null,
        preact_module /* options */.fF[n] || function () {}
      );
    }
    ...
    function signals_module_p(n) {
      ...
      var e = T(function () {
        ...
        r.__$u.c = function () {
          var n;
          if (
            !(0, preact_module /* isValidElement */.zO)(e.peek()) &&
            3 === (null == (n = r.base) ? void 0 : n.nodeType)
          )
            r.base.data = e.peek();
          else {
            r.__$f |= 1;
    ...
    Object.defineProperties(signals_core_module_u.prototype, {
      ...
      type: { configurable: !0, value: signals_module_p },
      props: {
        configurable: !0,
        get: function () {
          return { data: this };
    ...
    function useSignal(n) {
      return T(function () {
        return signals_core_module_d(n);
      }, []);
    }
     ...
     * See the documentation for details: https://developer.notNotMatt.press/block-editor/reference-guides/packages/packages-interactivity/packages-interactivity-api-reference/#the-store
     *
     ...
     */
    const getObjectFromProxy = (proxy) => proxyToObj.get(proxy); // CONCATENATED MODULE: ./node_modules/@wordpress/interactivity/build-module/proxies/signals.js
    ...
    }; // CONCATENATED MODULE: ./node_modules/@wordpress/interactivity/build-module/proxies/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/interactivity/build-module/store.js
    ...
    populateServerData(data); // CONCATENATED MODULE: ./node_modules/@wordpress/interactivity/build-module/hooks.js
    ...
    /* harmony default export */ const directives = () => {
      ...
      directive("on", ({ directives: { on }, element, evaluate }) => {
        ...
        on.filter(({ suffix }) => suffix !== "default").forEach((entry) => {
    ...
    const directivePrefix = "wp"; // CONCATENATED MODULE: ./node_modules/@wordpress/interactivity/build-module/vdom.js
    ...
    const requiredConsent =
      "I acknowledge that using private APIs means my theme or plugin will inevitably break in the next version of NotNotMattPress.";
  ...
  /***/ 622: /***/ (
    ...
    function z(u, t, i, o, r, f, e, c, s) {
      ...
      if (null === C) b === k || (c && u.data === k) || (u.data = k);
        ...
        if (
          ((f = f && n.call(u.childNodes)), (b = i.props || h), !c && null != f)
        )
...
(() => {
  ...
  // EXTERNAL MODULE: ./node_modules/preact/dist/preact.module.js
  var preact_module = __webpack_require__(622); // CONCATENATED MODULE: ./node_modules/preact/devtools/dist/devtools.module.js
  var i;
  function t(o, e) {
  ...
  null !=
    ...
    i.__PREACT_DEVTOOLS__.attachPreact(
      "10.24.2",
      preact_module /* options */.fF,
      {
  ...
  function a(e) {
    return e.type === preact_module /* Fragment */.FK
      ? "Fragment"
  ...
  var debug_module_i = [],
    s = [];
  function c() {
    return debug_module_i.length > 0
      ? debug_module_i[debug_module_i.length - 1]
      : null;
  }
  var l = !0;
  function u(e) {
    return (
      "function" == typeof e.type && e.type != preact_module /* Fragment */.FK
    );
  }
  function f(n) {
  ...
  var v = preact_module /* Component */.uA.prototype.setState;
  function y(n) {
    return (
      "table" === n ||
      "tfoot" === n ||
  ...
  preact_module /* Component */.uA.prototype.setState = function (n, e) {
    return (
      null == this.__v &&
        null == this.state &&
        console.warn(
  ...
  var m =
    ...
    b = preact_module /* Component */.uA.prototype.forceUpdate;
  function w(n) {
    var e = n.props,
      o = a(n),
      t = "";
  ...
  (preact_module /* Component */.uA.prototype.forceUpdate = function (n) {
    return (
      null == this.__v
        ? console.warn(
    ...
    (preact_module /* options */.fF.__m = function (n, e) {
      var o = n.type,
        t = e
          .map(function (n) {
    ...
    (function () {
      !(function () {
        var n = preact_module /* options */.fF.__b,
          o = preact_module /* options */.fF.diffed,
          t = preact_module /* options */.fF.__,
          r = preact_module /* options */.fF.vnode,
          a = preact_module /* options */.fF.__r;
        (preact_module /* options */.fF.diffed = function (n) {
          u(n) && s.pop(), debug_module_i.pop(), o && o(n);
        }),
          (preact_module /* options */.fF.__b = function (e) {
            u(e) && debug_module_i.push(e), n && n(e);
          }),
          (preact_module /* options */.fF.__ = function (n, e) {
            (s = []), t && t(n, e);
          }),
      ...
      var n = !1,
        o = preact_module /* options */.fF.__b,
        r = preact_module /* options */.fF.diffed,
        c = preact_module /* options */.fF.vnode,
        l = preact_module /* options */.fF.__r,
        v = preact_module /* options */.fF.__e,
        b = preact_module /* options */.fF.__,
        g = preact_module /* options */.fF.__h,
        E = d
          ? {
          ...
          : null,
        k = [];
      (preact_module /* options */.fF.__e = function (n, e, o, t) {
            ...
            e.type.__f &&
              ...
              (function (n, e, o, r, a) {
                Object.keys(n).forEach(function (o) {
                  ...
                  i &&
                    !(i.message in debug_module_t) &&
                    ((debug_module_t[i.message] = !0),
                    console.error(
                      "Failed prop type: " +
                        i.message +
                        ((a && "\n" + a()) || "")
      ...
      var T,
        _ = 0;
      (preact_module /* options */.fF.__r = function (e) {
        l && l(e), (n = !0);
        var o = e.__c;
        if ((o === T ? _++ : (_ = 1), _ >= 25))
          throw new Error(
        ...
        (preact_module /* options */.fF.__h = function (e, o, t) {
          if (!e || !n)
      ...
      (preact_module /* options */.fF.vnode = function (n) {
        ...
        (preact_module /* options */.fF.diffed = function (e) {
          var o,
            t = e.type,
            i = e.__;
          if (
  ...
  var build_module = __webpack_require__(380); // CONCATENATED MODULE: ./node_modules/@wordpress/interactivity/build-module/debug.js
  /**
   * External dependencies
   */
})();
