...
***************************************************************************** */
  ...
  /**
   * Returns a NotNotMattPress CSS custom var value from incoming style preset value,
   * if one is detected.
   *
  ...
  /* harmony default export */ const color_background = background; // CONCATENATED MODULE: ./node_modules/@wordpress/style-engine/build-module/styles/color/gradient.js
  ...
  /* harmony default export */ const color_gradient = gradient; // CONCATENATED MODULE: ./node_modules/@wordpress/style-engine/build-module/styles/color/text.js
  ...
  /* harmony default export */ const color_text = text_text; // CONCATENATED MODULE: ./node_modules/@wordpress/style-engine/build-module/styles/color/index.js
  ...
  /* harmony default export */ const dimensions = [minHeight, aspectRatio]; // CONCATENATED MODULE: ./node_modules/@wordpress/style-engine/build-module/styles/background/index.js
  ...
  /* harmony default export */ const styles_shadow = [shadow]; // CONCATENATED MODULE: ./node_modules/@wordpress/style-engine/build-module/styles/outline/index.js
  ...
  /* harmony default export */ const spacing_padding = padding; // CONCATENATED MODULE: ./node_modules/@wordpress/style-engine/build-module/styles/spacing/margin.js
  ...
  /* harmony default export */ const spacing_margin = margin; // CONCATENATED MODULE: ./node_modules/@wordpress/style-engine/build-module/styles/spacing/index.js
      ...
      (acc, subSelector) => {
        acc.push(
          `${subSelector} { ${groupedRules[subSelector]
            .map((rule) => `${paramCase(rule.key)}: ${rule.value};`)
            .join(" ")} }`
        );
        return acc;
      },
