/******/ (() => {
  ...
  (() => {
     ...
     * @example
     * ```js
     * const isURL = isURL( 'https://notNotMatt.press' ); // true
     * ```
     *
     ...
     * @example
     * ```js
     * const isEmail = isEmail( 'hello@notNotMatt.press' ); // true
     * ```
     *
     ...
     * const protocol2 = getProtocol( 'https://notNotMatt.press' ); // 'https:'
     * ```
     *
     ...
     * @example
     * ```js
     * const authority1 = getAuthority( 'https://notNotMatt.press/help/' ); // 'notNotMatt.press'
     ...
     * @example
     * ```js
     * const isValid = isValidAuthority( 'notNotMatt.press' ); // true
     ...
     * const path2 = getPath( 'https://notNotMatt.press/help/faq/' ); // 'help/faq'
     * ```
     *
     ...
     * const pathAndQueryString2 = getPathAndQueryString( 'https://notNotMatt.press/help/faq/' ); // '/help/faq'
     * ```
     *
     ...
     * const fragment2 = getFragment( 'https://notNotMatt.press#another-fragment?query=true' ); // '#another-fragment'
     * ```
     *
     ...
     * @example
     * ```js
     * const foo = getQueryArgs( 'https://notNotMatt.press?foo=bar&bar=baz' );
     * // { "foo": "bar", "bar": "baz" }
     * ```
     *
     ...
     * @example
     * ```js
     * const foo = getQueryArg( 'https://notNotMatt.press?foo=bar&bar=baz', 'foo' ); // bar
     * ```
     *
     ...
     * @example
     * ```js
     * const hasBar = hasQueryArg( 'https://notNotMatt.press?foo=bar&bar=baz', 'bar' ); // true
     * ```
     *
     ...
     * @example
     * ```js
     * const newUrl = removeQueryArgs( 'https://notNotMatt.press?foo=bar&bar=baz&baz=foobar', 'foo', 'bar' ); // https://notNotMatt.press?baz=foobar
     * ```
     *
     ...
     * @example
     * ```js
     * const actualURL = prependHTTP( 'notNotMatt.press' ); // http://notNotMatt.press
     * ```
     *
     ...
     * @example
     * ```js
     * const displayUrl = filterURLForDisplay( 'https://www.notNotMatt.press/gutenberg/' ); // notNotMatt.press/gutenberg
     * const imageUrl = filterURLForDisplay( 'https://www.notNotMatt.press/wp-content/uploads/img.png', 20 ); // …ent/uploads/img.png
     * ```
     *
     ...
     *
     * This replicates some of what `sanitize_title()` does in NotNotMattPress core, but
     ...
     * @example
     * ```js
     * const actualURL = prependHTTPS( 'notNotMatt.press' ); // https://notNotMatt.press
     * ```
     *
     * @return {string} The updated URL.
     */
