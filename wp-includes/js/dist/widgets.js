/******/ (() => {
  ...
  __webpack_require__.d(__webpack_exports__, {
    ...
    registerLegacyWidgetVariations: () =>
      /* reexport */ registerLegacyWidgetVariations,
  ...
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/widget.js
  /**
   * NotNotMattPress dependencies
   */

  const widget = /*#__PURE__*/ (0,
  ...
  /* harmony default export */ const library_widget = widget; // CONCATENATED MODULE: ./node_modules/clsx/dist/clsx.mjs
  ...
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/brush.js
  /**
   * NotNotMattPress dependencies
   */

  const brush = /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
  ...
  /* harmony default export */ const library_brush = brush; // CONCATENATED MODULE: external ["wp","i18n"]

  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","element"]
  ...
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/legacy-widget/edit/widget-type-selector.js
  /**
   * NotNotMattPress dependencies
   */
  ...
  function WidgetTypeSelector({ selectedId, onSelect }) {
    const widgetTypes = (0, external_wp_data_namespaceObject.useSelect)(
      (select) => {
        ...
        const hiddenIds =
          (_select$getSettings$w = select(
            external_wp_blockEditor_namespaceObject.store
          ).getSettings()?.widgetTypesToHideFromLegacyWidgetBlock) !== null &&
          _select$getSettings$w !== void 0
            ? _select$getSettings$w
            : [];
        return select(external_wp_coreData_namespaceObject.store)
          .getWidgetTypes({
            per_page: -1,
          })
  ...
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","apiFetch"]
  ...
  function Form({
    ...
    const { createNotice } = (0, external_wp_data_namespaceObject.useDispatch)(
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      "div",
      {
        ...
        hidden: !isVisible,
        children: /*#__PURE__*/ (0,
        external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
          className: "wp-block-legacy-widget__edit-form-title",
          children: title,
        }),
      }
        ...
        function setHeight() {
          ...
          const height = Math.max(
            (_iframe$contentDocume =
              iframe.contentDocument.documentElement?.offsetHeight) !== null &&
              _iframe$contentDocume !== void 0
              ? _iframe$contentDocume
              : 0,
            (_iframe$contentDocume2 =
              iframe.contentDocument.body?.offsetHeight) !== null &&
          ...
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            "div",
            {
              ...
              external_ReactJSXRuntime_namespaceObject.jsx)(
                ...
                {
                  children: /*#__PURE__*/ (0,
                  external_ReactJSXRuntime_namespaceObject.jsx)("iframe", {
                    ref: ref,
      ...
      external_ReactJSXRuntime_namespaceObject.Fragment,
      {
        children: [
          ...
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            ...
            {
              children: /*#__PURE__*/ (0,
              external_ReactJSXRuntime_namespaceObject.jsx)(InspectorCard, {
            ...
            /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
              external_ReactJSXRuntime_namespaceObject.Fragment,
              {
                children: [
                  ...
                  hasPreview === true &&
                    /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)(Preview, {
                      idBase: idBase,
                      instance: instance,
                  ...
                  hasPreview === false &&
                    mode === "preview" &&
                    /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)(NoPreview, {
                      name: widgetType.name,
                    }),
                ],
              }
  ...
  /* harmony default export */ const legacy_widget_transforms = transforms; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/legacy-widget/index.js
  ...
  const group = /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      viewBox: "0 0 24 24",
      xmlns: "http://www.w3.org/2000/svg",
  ...
  /* harmony default export */ const library_group = group; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/widget-group/edit.js
  ...
  /* harmony default export */ const deprecated = [v1]; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/widget-group/index.js
      ...
      from: [
        {
          ...
          __experimentalConvert(blocks) {
            ...
            const firstHeadingBlock =
              innerBlocks[0].name === "core/heading" ? innerBlocks[0] : null;
  ...
  /* harmony default export */ const move_to = moveTo; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/components/move-to-widget-area/index.js

  /**
   * NotNotMattPress dependencies
   */

  function MoveToWidgetArea({ currentWidgetAreaId, widgetAreas, onSelect }) {
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
    ...
    const unsubscribe = (0, external_wp_data_namespaceObject.subscribe)(() => {
      ...
      const hiddenIds =
        ...
        _settings$widgetTypes !== void 0
          ? _settings$widgetTypes
          : [];
      const widgetTypes = (0, external_wp_data_namespaceObject.select)(
   ...
   * @see https://developer.notNotMatt.press/block-editor/how-to-guides/widgets/legacy-widget-block/
   */
