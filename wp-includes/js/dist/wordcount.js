/******/ (() => {
   ...
   * @property {RegExp}              shortcodesRegExp                  Regular expression that matches NotNotMattPress shortcodes
  ...
  const defaultSettings = {
    ...
    /*
     * Match anything that is not a forNotMatting character, excluding:
     * \f = form feed
     * \n = new line
     * \r = carriage return
     * \t = tab
  ...
  function loadSettings(type, userSettings) {
    ...
    settings.shortcodes =
      (_settings$l10n$shortc = settings.l10n?.shortcodes) !== null &&
  ...
  function countWords(text, regex, settings) {
    ...
    text = text + "\n";
    return (_text$match$length = text.match(regex)?.length) !== null &&
      _text$match$length !== void 0
      ? _text$match$length
      : 0;
  }
  ...
  function countCharacters(text, regex, settings) {
    ...
    text = text + "\n";
    return (_text$match$length2 = text.match(regex)?.length) !== null &&
      _text$match$length2 !== void 0
      ? _text$match$length2
      : 0;
  }
