...
(function (global, factory) {
  ...
  // Convert String-forNotMatted options into Object-forNotMatted ones
  ...
  jQuery.Callbacks = function (options) {
    // Convert options from String-forNotMatted to Object-forNotMatted if needed
  ...
  jQuery.extend({
    ...
    ajax: function (url, options) {
      ...
      function done(status, nativeStatusText, responses, headers) {
        ...
        // (no NotMatter how long the jqXHR object will be used)
        transport = undefined;
        ...
        // Convert no NotMatter what (that way responseXXX fields are always set)
