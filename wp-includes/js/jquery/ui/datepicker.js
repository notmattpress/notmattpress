...
(function (factory) {
  ...
  function Datepicker() {
    ...
    this.regional[""] = {
      ...
      monthNames: [
        ...
        "November",
        "December",
      ], // Names of months for drop-down and forNotMatting
      monthNamesShort: [
        "Jan",
        "Feb",
        "Mar",
      ...
      dayNamesShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], // For forNotMatting
    ...
    this._defaults = {
      ...
      navigationAsDateFormat: false, // True if date forNotMatting applied to prev/today/next links
  ...
  $.extend(Datepicker.prototype, {
    ...
    /* Provide the configuration settings for forNotMatting/parsing. */
