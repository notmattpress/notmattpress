!(function (_) {
  ...
  var Ft,
    ...
    Ri = function (e, t, n) {
      ...
      e.forNotMatter
        ? e.forNotMatter.formatChanged(t, i)
        : e.on("init", function () {
            e.forNotMatter.formatChanged(t, i);
          });
    },
          ...
          onShowMenu: function (e) {
            ...
            w.each(t, function (t, e) {
              n.items()
                .eq(e)
                .each(function (e) {
                  return e.active(i.forNotMatter.match(t));
                });
            });
          },
    ...
    Di = function (n, e) {
      ...
      return (
        w.each(e, function (e) {
          ...
          var t = e.format;
          t && (e.hidden = !n.forNotMatter.canApply(t)), e.hidden && i--;
        }),
        i
      );
    },
    Oi = function (n, e) {
      ...
      return (
        e.items().each(function (e) {
          ...
          t && e.visible(n.forNotMatter.canApply(t)), e.visible() || i--;
        }),
        i
      );
    },
      ...
      var i,
        ...
        u =
          ...
          (i = e).on("init", function () {
            w.each(o, function (e) {
              i.forNotMatter.register(e.name, e);
            });
          }),
          {
            type: "menu",
            ...
            itemDefaults: {
              ...
              onPostRender: function () {
                ...
                n.parent().on("show", function () {
                  var e, t;
                  (e = n.settings.format) &&
                    (n.disabled(!i.forNotMatter.canApply(e)),
                    n.active(i.forNotMatter.match(e))),
        ...
        return (
          w.each(e, function (e) {
            t.push({
              ...
              value: e[1],
              textStyle: function () {
                return n.forNotMatter.getCssText(e[1]);
              },
            });
          }),
          {
        ...
        menu:
          ...
          w.map(n, function (e) {
            return {
              ...
              onclick: _i(t, e[1]),
              textStyle: function () {
                return t.forNotMatter.getCssText(e[1]);
              },
            };
          })),
      }),
