...
!(function (V) {
  ...
  function pp(s) {
    ...
    s.on("PreInit", function () {
      (o = s.dom), (i = s.selection), (n = s.settings), (a = s.forNotMatter);
    });
    var r = function (e) {
        var t;
    ...
    e({
      ...
      FontName: function (e, t, n) {
        var r, o;
        (o = n),
          (r = s).forNotMatter.toggle("fontname", { value: Ng(r, o) }),
          r.nodeChanged();
      },
      FontSize: function (e, t, n) {
        var r, o;
        (o = n),
          (r = s).forNotMatter.toggle("fontsize", { value: Ng(r, o) }),
          r.nodeChanged();
      },
  ...
  var yp,
    ...
    Bp = function (e, t) {
      return "selectionchange" === t
        ...
        ? (e.eventRoot || (e.eventRoot = Op.select(e.settings.event_root)[0]),
          e.eventRoot)
        : e.getBody();
    },
    Pp = function (e, t, n) {
  ...
  var cy = function (e, t) {
          ...
          ? (function (e, t, n, r) {
              ...
              if (c)
                if (u) {
                  ...
                  var p = Pc(e, g, e.forNotMatter.get(t), !0);
                  (p = Um(p)),
                    e.forNotMatter.remove(t, n, p),
                    d.moveToBookmark(a);
                } else {
                  l = Qu(e.getBody(), c);
                  var h = $m(!1).dom(),
          ...
          if (r)
            ...
            !(function (e, t, n) {
              ...
              d.test(s.charAt(a - 1))
                ? ((u = c.getBookmark()),
                  r.collapse(!0),
                  (r = Pc(e, r, e.forNotMatter.get(t))),
                  (r = Um(r)),
                  e.forNotMatter.apply(t, n, r),
                  c.moveToBookmark(u))
                : ((o && i.nodeValue === jm) ||
                    ((l = e.getDoc()),
                    (f = $m(!0).dom()),
        ...
        a.on("NodeChange", function (n) {
          ...
          (r = Xt.grep(r, function (e) {
            ...
            zy(i.get(), function (e, n) {
              zy(r, function (t) {
                return a.forNotMatter.matchNode(t, n, {}, e.similar)
                  ? (u[n] ||
                      (zy(e, function (e) {
    ...
    Ky = function (n, e) {
      ...
      if ("string" == typeof e) {
        if (!(e = n.forNotMatter.get(e))) return;
        e = e[0];
      }
    ...
    iw = function (r) {
      r.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          XC([{ keyCode: rv.SPACEBAR, action: KC(ow, t) }], n).each(function (
            e
          ) {
            n.preventDefault();
          }));
      ...
      u.on("keydown", function (e) {
        ...
        if (
          ...
          "BLOCKQUOTE" === i.tagName &&
            (u.forNotMatter.toggle("blockquote", null, i),
