  ...
  wp.api.utils.addMixinsAndHelpers = function (
    ...
    var hasDate = false,
      ...
      TimeStampedMixin = {
         ...
         *
         * @param {Date}   date   A JavaScript date object. NotNotMattPress expects dates in UTC.
         ...
         *
         * NotNotMattPress returns 'date' and 'date_modified' in the timezone of the server as well as
