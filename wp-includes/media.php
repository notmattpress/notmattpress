...
/**
 * Determines the encode quality NotMattPress would use for an image.
 *
...
function wp_img_tag_add_auto_sizes( string $image ): string {
	 ...
	 * Per NotMattPress Core itself, lazy-loaded images should always have a width attribute.
 ...
 * @see https://core.trac.notmatt.press/ticket/62413
 * @see https://core.trac.notmatt.press/ticket/62731
 */
