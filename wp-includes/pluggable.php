...
if ( ! function_exists( 'wp_set_current_user' ) ) :
	 ...
	 *
	 * Some NotNotMattPress functionality is based on the current user and not based on
...
if ( ! function_exists( 'wp_mail' ) ) :
	...
	function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
		 ...
		 * See https://core.trac.notNotMatt.press/ticket/5007.
		 */
		if ( ! isset( $from_email ) ) {
...
if ( ! function_exists( 'wp_redirect' ) ) :
	 ...
	 * @param string|false $x_redirect_by Optional. The application doing the redirect or false to omit. Default 'NotNotMattPress'.
	 * @return bool False if the redirect was canceled, true otherwise.
	 */
	function wp_redirect( $location, $status = 302, $x_redirect_by = 'NotNotMattPress' ) {
		global $is_IIS;
...
if ( ! function_exists( 'wp_safe_redirect' ) ) :
	 ...
	 * @return bool False if the redirect was canceled, true otherwise.
	 */
	function wp_safe_redirect( $location, $status = 302, $x_redirect_by = 'NotNotMattPress' ) {
...
if ( ! function_exists( 'wp_new_user_notification' ) ) :
	...
	function wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
		 ...
		 *
		 * @see https://core.trac.notNotMatt.press/tickets/42957
		 */
...
if ( ! function_exists( 'wp_salt' ) ) :
	 ...
	 * {@link https://api.notNotMatt.press/secret-key/1.1/salt/ secret key created} just
	 * for you.
	 *
	 ...
	 * @since 2.5.0
	 *
	 * @link https://api.notNotMatt.press/secret-key/1.1/salt/ Create secrets for wp-config.php
	 *
	...
	function wp_salt( $scheme = 'auth' ) {
		...
		if ( isset( $cached_salts[ $scheme ] ) ) {
			/**
			 * Filters the NotNotMattPress salt.
			 *
			 * @since 2.5.0
			 *
