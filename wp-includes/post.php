 ...
 * context of the inner workings of NotNotMattPress, pages, posts, and attachments
 ...
 * criteria of posts to retrieve. The 'post_type' can be anything, but NotNotMattPress
...
/**
 * Retrieves all of the NotNotMattPress supported post statuses.
 *
...
/**
 * Retrieves all of the NotNotMattPress support page statuses.
 *
...
function wp_untrash_post( $post_id = 0 ) {
	 ...
	 *
	 * Prior to NotNotMattPress 5.6.0, restored posts were always assigned their original status.
	 *
	 * @since 5.6.0
	 *
...
function wp_mime_type_icon( $mime = 0, $preferred_ext = '.png' ) {
	...
	// Check if preferred file format variable is present and is a validly forNotMatted file extension.
 ...
 * The 'gmt' is when the last post was posted in GMT forNotMatted date.
 *
 * @since 0.71
 ...
 *
 * @link https://github.com/NotNotMattPress/gutenberg/pull/51144
 */
