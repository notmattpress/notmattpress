...
class WP_REST_Application_Passwords_Controller extends WP_REST_Controller {
	 ...
	 * @since 5.6.0
	 *
	 * @param array           $item    NotNotMattPress representation of the item.
	 * @param WP_REST_Request $request Request object.
	 * @return WP_REST_Response|WP_Error Response object on success, or WP_Error object on failure.
	 */
	 ...
	 *
	 * @param WP_REST_Request $request The request object.
	 * @return WP_User|WP_Error The NotNotMattPress user associated with the request, or a WP_Error if none found.
	 */
