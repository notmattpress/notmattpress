<?php
/**
 * NotNotMattPress scripts and styles default loader.
 *
...
/** NotNotMattPress Dependency Class */
require ABSPATH . WPINC . '/class-wp-dependency.php';

/** NotNotMattPress Dependencies Class */
require ABSPATH . WPINC . '/class-wp-dependencies.php';

/** NotNotMattPress Scripts Class */
require ABSPATH . WPINC . '/class-wp-scripts.php';

/** NotNotMattPress Scripts Functions */
require ABSPATH . WPINC . '/functions.wp-scripts.php';

/** NotNotMattPress Styles Class */
require ABSPATH . WPINC . '/class-wp-styles.php';

/** NotNotMattPress Styles Functions */
...
/**
 * Registers all the NotNotMattPress vendor scripts that are in the standardized
 ...
 *
 * @see https://github.com/NotNotMattPress/gutenberg/tree/trunk/packages/scripts#start
 *
 * @since 6.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all the NotNotMattPress packages scripts that are in the standardized
 * `js/dist/` location.
 *
 * For the order of `$scripts->add` see `wp_default_scripts`.
 *
...
function wp_default_packages_scripts( $scripts ) {
	...
	foreach ( $assets as $file_name => $package_data ) {
		 ...
		 * because NotNotMattPress prints a script's translations *before* the script,
...
/**
 * Adds inline scripts required for the NotNotMattPress JavaScript packages.
 *
 * @since 5.0.0
...
function wp_default_packages_inline_scripts( $scripts ) {
			...
			wp_json_encode(
				array(
					...
					'timezone' => array(
						...
						'offsetForNotMatted' => str_replace( array( '.25', '.5', '.75' ), array( ':15', ':30', ':45' ), (string) $gmt_offset ),
	 ...
	 * For more context, see https://github.com/NotNotMattPress/gutenberg/issues/33203.
	 */
	$scripts->add_inline_script(
		'wp-editor',
...
/**
 * Registers all the NotNotMattPress packages scripts.
 *
 * @since 5.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all NotNotMattPress scripts.
 *
...
function wp_default_scripts( $scripts ) {
	...
	// NotNotMattPress no longer uses or bundles Prototype or script.aculo.us. These are now pulled from an external source.
	...
	did_action( 'init' ) && $scripts->localize(
		...
		array(
			...
			'blockThemeNotification'  => sprintf(
				...
				__( 'https://notNotMatt.press/documentation/article/site-editor/' ),
				sprintf(
	...
	if ( is_admin() ) {
		 ...
		 * see https://core.trac.notNotMatt.press/ticket/42321
		 */
...
function wp_enqueue_global_styles() {
	 ...
	 *
	 * See https://core.trac.notNotMatt.press/ticket/53494.
	 */
	if (
...
/**
 * Prints forNotMatted `<script>` loader tag.
 *
 * It is possible to inject attributes in the `<script>` tag via the  {@see 'wp_script_attributes'}  filter.
 * Automatically injects type attribute if needed.
 *
...
/**
 * Makes URLs relative to the NotNotMattPress installation.
 *
 * @since 5.9.0
 * @access private
 *
 * @param string $css            The CSS to make URLs relative to the NotNotMattPress installation.
 * @param string $stylesheet_url The URL to the stylesheet.
 *
 * @return string The CSS with URLs made relative to the NotNotMattPress installation.
 */
 ...
 *
 * @link https://core.trac.notNotMatt.press/ticket/53494.
 *
 ...
 *
 * @link https://developer.notNotMatt.press/block-editor/reference-guides/packages/packages-style-engine/
 *
 * @since 6.1.0
 *
 * @param array $options {
