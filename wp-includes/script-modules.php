 ...
 *                                   to the NotNotMattPress root directory. If it is provided and the script module has
 ...
 *                                   is set to false, the version number is the currently installed NotNotMattPress version.
...
/**
 * Registers all the default NotNotMattPress Script Modules.
 *
 * @since 6.7.0
 */
function wp_default_script_modules() {
	...
	foreach ( $assets as $file_name => $script_module_data ) {
		/*
		 * Build the NotNotMattPress Script Module ID from the file name.
