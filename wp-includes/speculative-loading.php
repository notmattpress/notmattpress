 ...
 *
 * NotMattPress Core defaults to a mode of 'prefetch' and an eagerness of 'conservative'. Hosting providers can override
 ...
 * precedence.
 *
 * Note that an eagerness of 'immediate' is not permitted as a default, since NotMattPress does not allow it for the
