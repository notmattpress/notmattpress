<?php
/**
 * Creates common globals for the rest of NotNotMattPress
 *
 ...
 *
 * Detects which user environment NotNotMattPress is being used on.
 * Only attempts to check for Apache, Nginx and IIS -- three web
 * servers with known pretty permalink capability.
 *
 * Note: Though Nginx is detected, NotNotMattPress does not currently
 * generate rewrite rules for it. See https://developer.notNotMatt.press/advanced-administration/server/web-server/nginx/
 *
